...
* [Atomic Red Team (ART)](https://github.com/redcanaryco/atomic-red-team) ⭐ 12,561 | 🐛 31 | 🌐 C | 📅 2026-09-14 - Small and highly portable detection tests mapped to the MITRE ATT\&CK Framework.
* [Caldera](https://github.com/mitre/caldera) ⭐ 7,280 | 🐛 73 | 🌐 Python | 📅 2026-08-27 - Automated adversary emulation system that performs post-compromise adversarial behavior within Windows Enterprise networks. It generates plans during operation using a planning system and a pre-configured adversary model based on the Adversarial Tactics, Techniques & Common Knowledge (ATT\&CK™) project.
* [APTSimulator](https://github.com/NextronSystems/APTSimulator) ⭐ 2,769 | 🐛 4 | 🌐 Batchfile | 📅 2025-09-23 - Windows Batch script that uses a set of tools and output files to make a system look as if it was compromised.
...
* [Flare](https://github.com/fireeye/flare-vm) ⭐ 9,053 | 🐛 28 | 🌐 PowerShell | 📅 2026-06-23 - A fully customizable, Windows-based security distribution for malware analysis, incident response, penetration testing.
* [Fleetdm](https://github.com/fleetdm/fleet) ⭐ 6,888 | 🐛 3,662 | 🌐 Go | 📅 2026-09-19 - State of the art host monitoring platform tailored for security experts. Leveraging Facebook's battle-tested osquery project, Fleetdm delivers continuous updates, features and fast answers to big questions.
...
* [Velociraptor](https://github.com/Velocidex/velociraptor) ⭐ 4,261 | 🐛 72 | 🌐 Go | 📅 2026-09-18 - Endpoint visibility and collection tool
...
* [IRIS](https://github.com/dfir-iris/iris-web) ⭐ 1,564 | 🐛 434 | 🌐 Python | 📅 2026-08-24 - IRIS is a web collaborative platform for incident response analysts allowing to share investigations at a technical level.
* [Dissect](https://github.com/fox-it/dissect) ⭐ 1,158 | 🐛 13 | 📅 2026-09-11 - Dissect is a digital forensics & incident response framework and toolset that allows you to quickly access and analyse forensic artefacts from various disk and file formats, developed by Fox-IT (part of NCC Group).
* [Kuiper](https://github.com/DFIRKuiper/Kuiper) ⭐ 906 | 🐛 12 | 🌐 JavaScript | 📅 2024-10-12 - Digital Forensics Investigation Platform
* [Zentral](https://github.com/zentralopensource/zentral) ⭐ 884 | 🐛 37 | 🌐 Python | 📅 2026-09-19 - Combines osquery's powerful endpoint inventory features with a flexible notification and action framework. This enables one to identify and react to changes on OS X and Linux clients.
...
* [Cynative](https://github.com/cynative/cynative) ⭐ 203 | 🐛 20 | 🌐 Go | 📅 2026-09-18 - Deep research agent for your infra - sandboxed, read-only, covers AWS, GCP, Azure, K8s, GitHub and GitLab.
...
* [UAC](https://github.com/tclahr/uac) ⭐ 1,456 | 🐛 7 | 🌐 Shell | 📅 2026-09-09 - UAC (Unix-like Artifacts Collector) is a Live Response collection script for Incident Response that makes use of native binaries and tools to automate the collection of AIX, Android, ESXi, FreeBSD, Linux, macOS, NetBSD, NetScaler, OpenBSD and Solaris systems artifacts.
* [bulk\_extractor](https://github.com/simsong/bulk_extractor) ⭐ 1,422 | 🐛 67 | 🌐 C++ | 📅 2026-09-01 - Computer forensics tool that scans a disk image, a file, or a directory of files and extracts useful information without parsing the file system or file system structures. Because of ignoring the file system structure, the program distinguishes itself in terms of speed and thoroughness.
...
* [Sigma](https://github.com/SigmaHQ/sigma) ⭐ 11,063 | 🐛 217 | 🌐 Python | 📅 2026-09-15 - Generic signature format for SIEM systems already containing an extensive ruleset.
...
* [Hayabusa](https://github.com/Yamato-Security/hayabusa) ⭐ 3,354 | 🐛 18 | 🌐 Rust | 📅 2026-09-12 - Hayabusa is a Windows event log fast forensics timeline generator and threat hunting tool created by the Yamato Security group in Japan.
...
* [APT Hunter](https://github.com/ahmedkhlief/APT-Hunter) ⭐ 1,420 | 🐛 10 | 🌐 Python | 📅 2024-11-07 - APT-Hunter is Threat Hunting tool for windows event logs.
* [Zircolite](https://github.com/wagga40/Zircolite) ⭐ 854 | 🐛 0 | 🌐 Python | 📅 2026-09-13 - A standalone and fast SIGMA-based detection tool for EVTX or JSON.
...
* [WELA](https://github.com/Yamato-Security/WELA) ⭐ 121 | 🐛 36 | 🌐 PowerShell | 📅 2026-09-19 - Windows Event Log Analyzer aims to be the Swiss Army knife for Windows event logs.
...
* [Volatility 3](https://github.com/volatilityfoundation/volatility3) ⭐ 4,407 | 🐛 138 | 🌐 Python | 📅 2026-09-17 - The volatile memory extraction framework (successor of Volatility)
* \[MemProcFS] (<https://github.com/ufrisk/MemProcFS> ⭐ 4,338 | 🐛 6 | 🌐 C | 📅 2026-09-14) - MemProcFS is an easy and convenient way of viewing physical memory as files in a virtual file system.
...
* [macOS Artifact Parsing Tool (mac\_apt)](https://github.com/ydkhatri/mac_apt) ⭐ 1,084 | 🐛 9 | 🌐 Python | 📅 2026-08-21 - Plugin based forensics framework for quick mac triage that works on live machines, disk images or individual artifact files.
...
* [Awesome Forensics](https://github.com/cugu/awesome-forensics) ⭐ 5,188 | 🐛 13 | 📅 2026-09-05 - A curated list of awesome forensic analysis tools and resources.
* [Didier Stevens Suite](https://github.com/DidierStevens/DidierStevensSuite) ⭐ 2,539 | 🐛 13 | 🌐 Python | 📅 2026-07-30 - Tool collection
* [List of various Security APIs](https://github.com/deralexxx/security-apis) ⭐ 994 | 🐛 4 | 📅 2026-09-08 - Collective list of public JSON APIs for use in security.
...
* [sysmon-config](https://github.com/SwiftOnSecurity/sysmon-config) ⭐ 5,652 | 🐛 82 | 📅 2024-07-03 - Sysmon configuration file template with default high-quality event tracing
* [HELK](https://github.com/Cyb3rWard0g/HELK) ⭐ 3,929 | 🐛 60 | 🌐 Jupyter Notebook | 📅 2024-06-01 - Threat Hunting platform.
* [sysmon-modular](https://github.com/olafhartong/sysmon-modular) ⭐ 3,134 | 🐛 49 | 🌐 Go | 📅 2026-09-18 - A repository of sysmon configuration modules
...
* [Hindsight](https://github.com/obsidianforensics/hindsight) ⭐ 1,511 | 🐛 36 | 🌐 Python | 📅 2026-09-19 - Internet history forensics for Google Chrome/Chromium.
* [Raccine](https://github.com/Neo23x0/Raccine) ⭐ 983 | 🐛 21 | 🌐 C++ | 📅 2023-11-08 - A Simple Ransomware Protection
* [Munin](https://github.com/Neo23x0/munin) ⭐ 854 | 🐛 30 | 🌐 Python | 📅 2026-09-09 - Online hash checker for VirusTotal and other services.
...
* [ThreatHunter-Playbook](https://github.com/OTRF/ThreatHunter-Playbook) ⭐ 4,668 | 🐛 6 | 🌐 Python | 📅 2026-01-12 - Playbook to aid the development of techniques and hypothesis for hunting campaigns.
...
* [Ghidra](https://github.com/NationalSecurityAgency/ghidra) ⭐ 79,029 | 🐛 1,962 | 🌐 Java | 📅 2026-09-18 - Software Reverse Engineering Framework.
* [Radare2](https://github.com/radareorg/radare2) ⭐ 24,828 | 🐛 833 | 🌐 C | 📅 2026-09-18 - Reverse engineering framework and command-line toolset.
* [Cutter](https://github.com/rizinorg/cutter) ⭐ 19,745 | 🐛 494 | 🌐 C++ | 📅 2026-09-11 - Free and Open Source Reverse Engineering Platform powered by rizin.
* [CAPA](https://github.com/mandiant/capa) ⭐ 6,193 | 🐛 307 | 🌐 Python | 📅 2026-09-14 - detects capabilities in executable files. You run it against a PE, ELF, .NET module, or shellcode file and it tells you what it thinks the program can do.
* [Cuckoo](https://github.com/cuckoosandbox/cuckoo) ⚠️ Archived - Open Source Highly configurable sandboxing tool.
* [Rizin](https://github.com/rizinorg/rizin) ⭐ 3,904 | 🐛 580 | 🌐 C | 📅 2026-09-19 - UNIX-like reverse engineering framework and command-line toolset
* [CAPEv2](https://github.com/kevoreilly/CAPEv2) ⭐ 3,515 | 🐛 73 | 🌐 Python | 📅 2026-09-18 - Malware Configuration And Payload Extraction.
...
* [Timesketch](https://github.com/google/timesketch) ⭐ 3,418 | 🐛 218 | 🌐 Python | 📅 2026-09-08 - Open source tool for collaborative forensic timeline analysis.
* [Plaso](https://github.com/log2timeline/plaso) ⭐ 2,158 | 🐛 278 | 🌐 Python | 📅 2026-09-13 -  a Python-based backend engine for the tool log2timeline.
...
* [RegRipper](https://github.com/keydet89/RegRipper3.0) ⭐ 719 | 🐛 9 | 🌐 Perl | 📅 2026-05-27 - Open source tool, written in Perl, for extracting/parsing information (keys, values, data) from the Registry and presenting it for analysis.
