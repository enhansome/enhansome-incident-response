...
* [Atomic Red Team (ART)](https://github.com/redcanaryco/atomic-red-team) ⭐ 12,550 | 🐛 33 | 🌐 C | 📅 2026-09-14 - Small and highly portable detection tests mapped to the MITRE ATT\&CK Framework.
* [Caldera](https://github.com/mitre/caldera) ⭐ 7,271 | 🐛 74 | 🌐 Python | 📅 2026-08-27 - Automated adversary emulation system that performs post-compromise adversarial behavior within Windows Enterprise networks. It generates plans during operation using a planning system and a pre-configured adversary model based on the Adversarial Tactics, Techniques & Common Knowledge (ATT\&CK™) project.
...
* [Flare](https://github.com/fireeye/flare-vm) ⭐ 9,047 | 🐛 28 | 🌐 PowerShell | 📅 2026-06-23 - A fully customizable, Windows-based security distribution for malware analysis, incident response, penetration testing.
* [Fleetdm](https://github.com/fleetdm/fleet) ⭐ 6,873 | 🐛 3,621 | 🌐 Go | 📅 2026-09-17 - State of the art host monitoring platform tailored for security experts. Leveraging Facebook's battle-tested osquery project, Fleetdm delivers continuous updates, features and fast answers to big questions.
...
* [Velociraptor](https://github.com/Velocidex/velociraptor) ⭐ 4,255 | 🐛 74 | 🌐 Go | 📅 2026-09-17 - Endpoint visibility and collection tool
...
* [IRIS](https://github.com/dfir-iris/iris-web) ⭐ 1,563 | 🐛 434 | 🌐 Python | 📅 2026-08-24 - IRIS is a web collaborative platform for incident response analysts allowing to share investigations at a technical level.
* [Dissect](https://github.com/fox-it/dissect) ⭐ 1,156 | 🐛 13 | 📅 2026-09-11 - Dissect is a digital forensics & incident response framework and toolset that allows you to quickly access and analyse forensic artefacts from various disk and file formats, developed by Fox-IT (part of NCC Group).
* [Kuiper](https://github.com/DFIRKuiper/Kuiper) ⭐ 906 | 🐛 12 | 🌐 JavaScript | 📅 2024-10-12 - Digital Forensics Investigation Platform
* [Zentral](https://github.com/zentralopensource/zentral) ⭐ 882 | 🐛 39 | 🌐 Python | 📅 2026-09-17 - Combines osquery's powerful endpoint inventory features with a flexible notification and action framework. This enables one to identify and react to changes on OS X and Linux clients.
...
* [Cynative](https://github.com/cynative/cynative) ⭐ 203 | 🐛 20 | 🌐 Go | 📅 2026-09-17 - Deep research agent for your infra - sandboxed, read-only, covers AWS, GCP, Azure, K8s, GitHub and GitLab.
...
* [Bitscout](https://github.com/vitaly-kamluk/bitscout) ⭐ 481 | 🐛 0 | 🌐 Shell | 📅 2025-03-21 - Bitscout by Vitaly Kamluk helps you build your fully-trusted customizable LiveCD/LiveUSB image to be used for remote digital forensics (or perhaps any other task of your choice). It is meant to be transparent and monitorable by the owner of the system, forensically sound, customizable and compact.
...
* [DFTimewolf](https://github.com/log2timeline/dftimewolf) ⭐ 355 | 🐛 4 | 🌐 Python | 📅 2026-09-17 - A framework for orchestrating forensic collection, processing and data export.
...
* [Windows Events Attack Samples](https://github.com/sbousseaden/EVTX-ATTACK-SAMPLES) ⭐ 2,627 | 🐛 5 | 🌐 HTML | 📅 2023-01-24 - Windows Events Attack Samples
...
* [MAGNET DumpIt](https://github.com/MagnetForensics/dumpit-linux) ⭐ 250 | 🐛 3 | 🌐 Rust | 📅 2023-11-21 - Fast memory acquisition open source tool for Linux written in Rust. Generate full memory crash dumps of Linux machines.
...
* [Sigma](https://github.com/SigmaHQ/sigma) ⭐ 11,054 | 🐛 214 | 🌐 Python | 📅 2026-09-15 - Generic signature format for SIEM systems already containing an extensive ruleset.
...
* [Hayabusa](https://github.com/Yamato-Security/hayabusa) ⭐ 3,346 | 🐛 18 | 🌐 Rust | 📅 2026-09-12 - Hayabusa is a Windows event log fast forensics timeline generator and threat hunting tool created by the Yamato Security group in Japan.
* [LogonTracer](https://github.com/JPCERTCC/LogonTracer) ⭐ 3,232 | 🐛 22 | 🌐 Python | 📅 2026-08-02 - Tool to investigate malicious Windows logon by visualizing and analyzing Windows event log.
...
* [WELA](https://github.com/Yamato-Security/WELA) ⭐ 120 | 🐛 5 | 🌐 PowerShell | 📅 2026-09-14 - Windows Event Log Analyzer aims to be the Swiss Army knife for Windows event logs.
...
* [Volatility 3](https://github.com/volatilityfoundation/volatility3) ⭐ 4,399 | 🐛 138 | 🌐 Python | 📅 2026-09-17 - The volatile memory extraction framework (successor of Volatility)
* \[MemProcFS] (<https://github.com/ufrisk/MemProcFS> ⭐ 4,335 | 🐛 6 | 🌐 C | 📅 2026-09-14) - MemProcFS is an easy and convenient way of viewing physical memory as files in a virtual file system.
...
* [AVML](https://github.com/microsoft/avml) ⭐ 1,120 | 🐛 7 | 🌐 Rust | 📅 2026-09-14 - A portable volatile memory acquisition tool for Linux.
...
* [Orochi](https://github.com/LDO-CERT/orochi) ⭐ 277 | 🐛 67 | 🌐 JavaScript | 📅 2026-09-14 - Orochi is an open source framework for collaborative forensic memory dump analysis.
...
* [sysmon-modular](https://github.com/olafhartong/sysmon-modular) ⭐ 3,131 | 🐛 49 | 🌐 PowerShell | 📅 2026-09-09 - A repository of sysmon configuration modules
...
* [Hindsight](https://github.com/obsidianforensics/hindsight) ⭐ 1,508 | 🐛 38 | 🌐 Python | 📅 2026-09-13 - Internet history forensics for Google Chrome/Chromium.
...
* [ThreatHunter-Playbook](https://github.com/OTRF/ThreatHunter-Playbook) ⭐ 4,667 | 🐛 6 | 🌐 Python | 📅 2026-01-12 - Playbook to aid the development of techniques and hypothesis for hunting campaigns.
...
* [Counteractive Playbooks](https://github.com/counteractive/incident-response-plan-template/tree/master/playbooks) ⭐ 805 | 🐛 5 | 🌐 Makefile | 📅 2024-05-07 - Counteractive PLaybooks collection.
...
* [Ghidra](https://github.com/NationalSecurityAgency/ghidra) ⭐ 78,422 | 🐛 1,962 | 🌐 Java | 📅 2026-09-17 - Software Reverse Engineering Framework.
* [Radare2](https://github.com/radareorg/radare2) ⭐ 24,821 | 🐛 823 | 🌐 C | 📅 2026-09-16 - Reverse engineering framework and command-line toolset.
* [Cutter](https://github.com/rizinorg/cutter) ⭐ 19,741 | 🐛 494 | 🌐 C++ | 📅 2026-09-11 - Free and Open Source Reverse Engineering Platform powered by rizin.
* [CAPA](https://github.com/mandiant/capa) ⭐ 6,185 | 🐛 307 | 🌐 Python | 📅 2026-09-14 - detects capabilities in executable files. You run it against a PE, ELF, .NET module, or shellcode file and it tells you what it thinks the program can do.
* [Cuckoo](https://github.com/cuckoosandbox/cuckoo) ⚠️ Archived - Open Source Highly configurable sandboxing tool.
* [Rizin](https://github.com/rizinorg/rizin) ⭐ 3,900 | 🐛 575 | 🌐 C | 📅 2026-09-17 - UNIX-like reverse engineering framework and command-line toolset
* [CAPEv2](https://github.com/kevoreilly/CAPEv2) ⭐ 3,507 | 🐛 71 | 🌐 Python | 📅 2026-09-16 - Malware Configuration And Payload Extraction.
...
* [Timesketch](https://github.com/google/timesketch) ⭐ 3,416 | 🐛 217 | 🌐 Python | 📅 2026-09-08 - Open source tool for collaborative forensic timeline analysis.
...
* [LOKI](https://github.com/Neo23x0/Loki) ⭐ 3,790 | 🐛 18 | 🌐 Python | 📅 2026-01-12 - Free IR scanner for scanning endpoint with yara rules and other indicators(IOCs).
* [Fibratus](https://github.com/rabbitstack/fibratus) ⭐ 2,545 | 🐛 44 | 🌐 Go | 📅 2026-09-17 - Tool for exploration and tracing of the Windows kernel.
