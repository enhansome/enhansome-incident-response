...
* [Atomic Red Team (ART)](https://github.com/redcanaryco/atomic-red-team) ⭐ 12,511 | 🐛 33 | 🌐 C | 📅 2026-09-05 - Small and highly portable detection tests mapped to the MITRE ATT\&CK Framework.
* [Caldera](https://github.com/mitre/caldera) ⭐ 7,250 | 🐛 71 | 🌐 Python | 📅 2026-08-27 - Automated adversary emulation system that performs post-compromise adversarial behavior within Windows Enterprise networks. It generates plans during operation using a planning system and a pre-configured adversary model based on the Adversarial Tactics, Techniques & Common Knowledge (ATT\&CK™) project.
* [APTSimulator](https://github.com/NextronSystems/APTSimulator) ⭐ 2,767 | 🐛 4 | 🌐 Batchfile | 📅 2025-09-23 - Windows Batch script that uses a set of tools and output files to make a system look as if it was compromised.
...
* [Flare](https://github.com/fireeye/flare-vm) ⭐ 9,014 | 🐛 28 | 🌐 PowerShell | 📅 2026-06-23 - A fully customizable, Windows-based security distribution for malware analysis, incident response, penetration testing.
* [Fleetdm](https://github.com/fleetdm/fleet) ⭐ 6,827 | 🐛 3,506 | 🌐 Go | 📅 2026-09-09 - State of the art host monitoring platform tailored for security experts. Leveraging Facebook's battle-tested osquery project, Fleetdm delivers continuous updates, features and fast answers to big questions.
...
* [Dissect](https://github.com/fox-it/dissect) ⭐ 1,152 | 🐛 10 | 📅 2026-02-25 - Dissect is a digital forensics & incident response framework and toolset that allows you to quickly access and analyse forensic artefacts from various disk and file formats, developed by Fox-IT (part of NCC Group).
* [Kuiper](https://github.com/DFIRKuiper/Kuiper) ⭐ 905 | 🐛 12 | 🌐 JavaScript | 📅 2024-10-12 - Digital Forensics Investigation Platform
* [Zentral](https://github.com/zentralopensource/zentral) ⭐ 880 | 🐛 38 | 🌐 Python | 📅 2026-09-09 - Combines osquery's powerful endpoint inventory features with a flexible notification and action framework. This enables one to identify and react to changes on OS X and Linux clients.
...
* [Cynative](https://github.com/cynative/cynative) ⭐ 199 | 🐛 21 | 🌐 Go | 📅 2026-09-09 - Deep research agent for your infra - sandboxed, read-only, covers AWS, GCP, Azure, K8s, GitHub and GitLab.
...
* [UAC](https://github.com/tclahr/uac) ⭐ 1,449 | 🐛 8 | 🌐 Shell | 📅 2026-09-09 - UAC (Unix-like Artifacts Collector) is a Live Response collection script for Incident Response that makes use of native binaries and tools to automate the collection of AIX, Android, ESXi, FreeBSD, Linux, macOS, NetBSD, NetScaler, OpenBSD and Solaris systems artifacts.
...
* [Shuffle](https://github.com/frikky/Shuffle) ⭐ 2,430 | 🐛 491 | 🌐 JavaScript | 📅 2026-09-07 - A general purpose security automation platform focused on accessibility.
...
* [Sigma](https://github.com/SigmaHQ/sigma) ⭐ 11,009 | 🐛 201 | 🌐 Python | 📅 2026-09-07 - Generic signature format for SIEM systems already containing an extensive ruleset.
...
* [Hayabusa](https://github.com/Yamato-Security/hayabusa) ⭐ 3,339 | 🐛 18 | 🌐 Rust | 📅 2026-09-05 - Hayabusa is a Windows event log fast forensics timeline generator and threat hunting tool created by the Yamato Security group in Japan.
...
* [Volatility 3](https://github.com/volatilityfoundation/volatility3) ⭐ 4,378 | 🐛 136 | 🌐 Python | 📅 2026-09-09 - The volatile memory extraction framework (successor of Volatility)
* \[MemProcFS] (<https://github.com/ufrisk/MemProcFS> ⭐ 4,323 | 🐛 4 | 🌐 C | 📅 2026-09-08) - MemProcFS is an easy and convenient way of viewing physical memory as files in a virtual file system.
...
* [Orochi](https://github.com/LDO-CERT/orochi) ⭐ 275 | 🐛 92 | 🌐 JavaScript | 📅 2026-09-09 - Orochi is an open source framework for collaborative forensic memory dump analysis.
...
* [Hindsight](https://github.com/obsidianforensics/hindsight) ⭐ 1,504 | 🐛 36 | 🌐 Python | 📅 2026-09-07 - Internet history forensics for Google Chrome/Chromium.
...
* [Counteractive Playbooks](https://github.com/counteractive/incident-response-plan-template/tree/master/playbooks) ⭐ 804 | 🐛 5 | 🌐 Makefile | 📅 2024-05-07 - Counteractive PLaybooks collection.
...
* [Ghidra](https://github.com/NationalSecurityAgency/ghidra) ⭐ 74,685 | 🐛 1,945 | 🌐 Java | 📅 2026-09-08 - Software Reverse Engineering Framework.
* [Radare2](https://github.com/radareorg/radare2) ⭐ 24,770 | 🐛 823 | 🌐 C | 📅 2026-09-09 - Reverse engineering framework and command-line toolset.
* [Cutter](https://github.com/rizinorg/cutter) ⭐ 19,706 | 🐛 493 | 🌐 C++ | 📅 2026-08-22 - Free and Open Source Reverse Engineering Platform powered by rizin.
* [CAPA](https://github.com/mandiant/capa) ⭐ 6,177 | 🐛 299 | 🌐 Python | 📅 2026-09-08 - detects capabilities in executable files. You run it against a PE, ELF, .NET module, or shellcode file and it tells you what it thinks the program can do.
* [Cuckoo](https://github.com/cuckoosandbox/cuckoo) ⚠️ Archived - Open Source Highly configurable sandboxing tool.
* [Rizin](https://github.com/rizinorg/rizin) ⭐ 3,878 | 🐛 567 | 🌐 C | 📅 2026-09-09 - UNIX-like reverse engineering framework and command-line toolset
* [CAPEv2](https://github.com/kevoreilly/CAPEv2) ⭐ 3,481 | 🐛 54 | 🌐 Python | 📅 2026-09-09 - Malware Configuration And Payload Extraction.
...
* [Timesketch](https://github.com/google/timesketch) ⭐ 3,410 | 🐛 215 | 🌐 Python | 📅 2026-09-08 - Open source tool for collaborative forensic timeline analysis.
* [Plaso](https://github.com/log2timeline/plaso) ⭐ 2,151 | 🐛 275 | 🌐 Python | 📅 2026-08-28 -  a Python-based backend engine for the tool log2timeline.
...
* [LOKI](https://github.com/Neo23x0/Loki) ⭐ 3,788 | 🐛 18 | 🌐 Python | 📅 2026-01-12 - Free IR scanner for scanning endpoint with yara rules and other indicators(IOCs).
* [Fibratus](https://github.com/rabbitstack/fibratus) ⭐ 2,541 | 🐛 44 | 🌐 Go | 📅 2026-09-08 - Tool for exploration and tracing of the Windows kernel.
