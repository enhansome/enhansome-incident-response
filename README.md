...
* [Atomic Red Team (ART)](https://github.com/redcanaryco/atomic-red-team) ⭐ 12,570 | 🐛 32 | 🌐 C | 📅 2026-09-14 - Small and highly portable detection tests mapped to the MITRE ATT\&CK Framework.
* [Caldera](https://github.com/mitre/caldera) ⭐ 7,284 | 🐛 73 | 🌐 Python | 📅 2026-08-27 - Automated adversary emulation system that performs post-compromise adversarial behavior within Windows Enterprise networks. It generates plans during operation using a planning system and a pre-configured adversary model based on the Adversarial Tactics, Techniques & Common Knowledge (ATT\&CK™) project.
...
* [Flare](https://github.com/fireeye/flare-vm) ⭐ 9,060 | 🐛 26 | 🌐 PowerShell | 📅 2026-06-23 - A fully customizable, Windows-based security distribution for malware analysis, incident response, penetration testing.
* [Fleetdm](https://github.com/fleetdm/fleet) ⭐ 6,896 | 🐛 3,532 | 🌐 Go | 📅 2026-09-21 - State of the art host monitoring platform tailored for security experts. Leveraging Facebook's battle-tested osquery project, Fleetdm delivers continuous updates, features and fast answers to big questions.
* [GRR Rapid Response](https://github.com/google/grr) ⭐ 5,090 | 🐛 191 | 🌐 Python | 📅 2026-05-12 - Incident response framework focused on remote live forensics. It consists of a python agent (client) that is installed on target systems, and a python server infrastructure that can manage and talk to the agent. Besides the included Python API client, [PowerGRR](https://github.com/swisscom/PowerGRR) ⭐ 57 | 🐛 1 | 🌐 PowerShell | 📅 2022-03-18 provides an API client library in PowerShell working on Windows, Linux and macOS for GRR automation and scripting.
...
* [Zentral](https://github.com/zentralopensource/zentral) ⭐ 884 | 🐛 38 | 🌐 Python | 📅 2026-09-21 - Combines osquery's powerful endpoint inventory features with a flexible notification and action framework. This enables one to identify and react to changes on OS X and Linux clients.
...
* [Cynative](https://github.com/cynative/cynative) ⭐ 203 | 🐛 20 | 🌐 Go | 📅 2026-09-21 - Deep research agent for your infra - sandboxed, read-only, covers AWS, GCP, Azure, K8s, GitHub and GitLab.
...
* [UAC](https://github.com/tclahr/uac) ⭐ 1,460 | 🐛 7 | 🌐 Shell | 📅 2026-09-09 - UAC (Unix-like Artifacts Collector) is a Live Response collection script for Incident Response that makes use of native binaries and tools to automate the collection of AIX, Android, ESXi, FreeBSD, Linux, macOS, NetBSD, NetScaler, OpenBSD and Solaris systems artifacts.
...
* [Shuffle](https://github.com/frikky/Shuffle) ⭐ 2,442 | 🐛 493 | 🌐 JavaScript | 📅 2026-09-21 - A general purpose security automation platform focused on accessibility.
...
* [DFTimewolf](https://github.com/log2timeline/dftimewolf) ⭐ 355 | 🐛 5 | 🌐 Python | 📅 2026-09-21 - A framework for orchestrating forensic collection, processing and data export.
...
* [Sigma](https://github.com/SigmaHQ/sigma) ⭐ 11,073 | 🐛 219 | 🌐 Python | 📅 2026-09-21 - Generic signature format for SIEM systems already containing an extensive ruleset.
* [Chainsaw](https://github.com/countercept/chainsaw) ⭐ 3,665 | 🐛 6 | 🌐 Rust | 📅 2026-08-25 - Chainsaw provides a powerful ‘first-response’ capability to quickly identify threats within Windows event logs.
* [Hayabusa](https://github.com/Yamato-Security/hayabusa) ⭐ 3,359 | 🐛 18 | 🌐 Rust | 📅 2026-09-12 - Hayabusa is a Windows event log fast forensics timeline generator and threat hunting tool created by the Yamato Security group in Japan.
...
* [WELA](https://github.com/Yamato-Security/WELA) ⭐ 121 | 🐛 40 | 🌐 PowerShell | 📅 2026-09-21 - Windows Event Log Analyzer aims to be the Swiss Army knife for Windows event logs.
...
* [Volatility 3](https://github.com/volatilityfoundation/volatility3) ⭐ 4,417 | 🐛 139 | 🌐 Python | 📅 2026-09-17 - The volatile memory extraction framework (successor of Volatility)
* \[MemProcFS] (<https://github.com/ufrisk/MemProcFS> ⭐ 4,345 | 🐛 6 | 🌐 C | 📅 2026-09-14) - MemProcFS is an easy and convenient way of viewing physical memory as files in a virtual file system.
...
* [AVML](https://github.com/microsoft/avml) ⭐ 1,121 | 🐛 9 | 🌐 Rust | 📅 2026-09-21 - A portable volatile memory acquisition tool for Linux.
...
* [Orochi](https://github.com/LDO-CERT/orochi) ⭐ 277 | 🐛 68 | 🌐 JavaScript | 📅 2026-09-21 - Orochi is an open source framework for collaborative forensic memory dump analysis.
...
* [sysmon-modular](https://github.com/olafhartong/sysmon-modular) ⭐ 3,139 | 🐛 49 | 🌐 Go | 📅 2026-09-18 - A repository of sysmon configuration modules
...
* [Hindsight](https://github.com/obsidianforensics/hindsight) ⭐ 1,514 | 🐛 37 | 🌐 Python | 📅 2026-09-19 - Internet history forensics for Google Chrome/Chromium.
...
* [Phantom Community Playbooks](https://github.com/phantomcyber/playbooks) ⭐ 554 | 🐛 17 | 🌐 Python | 📅 2026-09-21 - Phantom Community Playbooks for Splunk but also customizable for other use.
...
* [Ghidra](https://github.com/NationalSecurityAgency/ghidra) ⭐ 79,295 | 🐛 1,966 | 🌐 Java | 📅 2026-09-21 - Software Reverse Engineering Framework.
* [Radare2](https://github.com/radareorg/radare2) ⭐ 24,843 | 🐛 826 | 🌐 C | 📅 2026-09-21 - Reverse engineering framework and command-line toolset.
* [Cutter](https://github.com/rizinorg/cutter) ⭐ 19,772 | 🐛 494 | 🌐 C++ | 📅 2026-09-11 - Free and Open Source Reverse Engineering Platform powered by rizin.
...
* [Rizin](https://github.com/rizinorg/rizin) ⭐ 3,908 | 🐛 586 | 🌐 C | 📅 2026-09-21 - UNIX-like reverse engineering framework and command-line toolset
* [CAPEv2](https://github.com/kevoreilly/CAPEv2) ⭐ 3,523 | 🐛 71 | 🌐 Python | 📅 2026-09-21 - Malware Configuration And Payload Extraction.
...
* [Timesketch](https://github.com/google/timesketch) ⭐ 3,419 | 🐛 219 | 🌐 Python | 📅 2026-09-08 - Open source tool for collaborative forensic timeline analysis.
...
* [LOKI](https://github.com/Neo23x0/Loki) ⭐ 3,791 | 🐛 18 | 🌐 Python | 📅 2026-01-12 - Free IR scanner for scanning endpoint with yara rules and other indicators(IOCs).
* [Fibratus](https://github.com/rabbitstack/fibratus) ⭐ 2,548 | 🐛 44 | 🌐 Go | 📅 2026-09-21 - Tool for exploration and tracing of the Windows kernel.
