...
* [Atomic Red Team (ART)](https://github.com/redcanaryco/atomic-red-team) ⭐ 12,526 | 🐛 33 | 🌐 C | 📅 2026-09-05 - Small and highly portable detection tests mapped to the MITRE ATT\&CK Framework.
* [Caldera](https://github.com/mitre/caldera) ⭐ 7,257 | 🐛 72 | 🌐 Python | 📅 2026-08-27 - Automated adversary emulation system that performs post-compromise adversarial behavior within Windows Enterprise networks. It generates plans during operation using a planning system and a pre-configured adversary model based on the Adversarial Tactics, Techniques & Common Knowledge (ATT\&CK™) project.
...
* [Fleetdm](https://github.com/fleetdm/fleet) ⭐ 6,841 | 🐛 3,530 | 🌐 Go | 📅 2026-09-12 - State of the art host monitoring platform tailored for security experts. Leveraging Facebook's battle-tested osquery project, Fleetdm delivers continuous updates, features and fast answers to big questions.
...
* [Velociraptor](https://github.com/Velocidex/velociraptor) ⭐ 4,243 | 🐛 80 | 🌐 Go | 📅 2026-09-10 - Endpoint visibility and collection tool
...
* [Cynative](https://github.com/cynative/cynative) ⭐ 200 | 🐛 20 | 🌐 Go | 📅 2026-09-12 - Deep research agent for your infra - sandboxed, read-only, covers AWS, GCP, Azure, K8s, GitHub and GitLab.
...
* [UAC](https://github.com/tclahr/uac) ⭐ 1,452 | 🐛 7 | 🌐 Shell | 📅 2026-09-09 - UAC (Unix-like Artifacts Collector) is a Live Response collection script for Incident Response that makes use of native binaries and tools to automate the collection of AIX, Android, ESXi, FreeBSD, Linux, macOS, NetBSD, NetScaler, OpenBSD and Solaris systems artifacts.
...
* [Shuffle](https://github.com/frikky/Shuffle) ⭐ 2,434 | 🐛 493 | 🌐 JavaScript | 📅 2026-09-10 - A general purpose security automation platform focused on accessibility.
...
* [Sigma](https://github.com/SigmaHQ/sigma) ⭐ 11,033 | 🐛 203 | 🌐 Python | 📅 2026-09-07 - Generic signature format for SIEM systems already containing an extensive ruleset.
...
* [Hayabusa](https://github.com/Yamato-Security/hayabusa) ⭐ 3,343 | 🐛 18 | 🌐 Rust | 📅 2026-09-12 - Hayabusa is a Windows event log fast forensics timeline generator and threat hunting tool created by the Yamato Security group in Japan.
...
* [Volatility 3](https://github.com/volatilityfoundation/volatility3) ⭐ 4,388 | 🐛 137 | 🌐 Python | 📅 2026-09-09 - The volatile memory extraction framework (successor of Volatility)
...
* [Hindsight](https://github.com/obsidianforensics/hindsight) ⭐ 1,506 | 🐛 36 | 🌐 Python | 📅 2026-09-07 - Internet history forensics for Google Chrome/Chromium.
...
* [Ghidra](https://github.com/NationalSecurityAgency/ghidra) ⭐ 74,872 | 🐛 1,942 | 🌐 Java | 📅 2026-09-11 - Software Reverse Engineering Framework.
* [Radare2](https://github.com/radareorg/radare2) ⭐ 24,782 | 🐛 829 | 🌐 C | 📅 2026-09-12 - Reverse engineering framework and command-line toolset.
...
* [Rizin](https://github.com/rizinorg/rizin) ⭐ 3,891 | 🐛 564 | 🌐 C | 📅 2026-09-12 - UNIX-like reverse engineering framework and command-line toolset
* [CAPEv2](https://github.com/kevoreilly/CAPEv2) ⭐ 3,489 | 🐛 53 | 🌐 Python | 📅 2026-09-10 - Malware Configuration And Payload Extraction.
...
* [Plaso](https://github.com/log2timeline/plaso) ⭐ 2,152 | 🐛 277 | 🌐 Python | 📅 2026-08-28 -  a Python-based backend engine for the tool log2timeline.
