...
* [Atomic Red Team (ART)](https://github.com/redcanaryco/atomic-red-team) ⭐ 12,573 | 🐛 34 | 🌐 C | 📅 2026-09-14 - Small and highly portable detection tests mapped to the MITRE ATT\&CK Framework.
...
* [Fleetdm](https://github.com/fleetdm/fleet) ⭐ 6,901 | 🐛 3,574 | 🌐 Go | 📅 2026-09-22 - State of the art host monitoring platform tailored for security experts. Leveraging Facebook's battle-tested osquery project, Fleetdm delivers continuous updates, features and fast answers to big questions.
...
* [Velociraptor](https://github.com/Velocidex/velociraptor) ⭐ 4,267 | 🐛 75 | 🌐 Go | 📅 2026-09-21 - Endpoint visibility and collection tool
...
* [IRIS](https://github.com/dfir-iris/iris-web) ⭐ 1,566 | 🐛 434 | 🌐 Python | 📅 2026-08-24 - IRIS is a web collaborative platform for incident response analysts allowing to share investigations at a technical level.
...
* [Zentral](https://github.com/zentralopensource/zentral) ⭐ 884 | 🐛 39 | 🌐 Python | 📅 2026-09-22 - Combines osquery's powerful endpoint inventory features with a flexible notification and action framework. This enables one to identify and react to changes on OS X and Linux clients.
...
* [Cynative](https://github.com/cynative/cynative) ⭐ 204 | 🐛 20 | 🌐 Go | 📅 2026-09-22 - Deep research agent for your infra - sandboxed, read-only, covers AWS, GCP, Azure, K8s, GitHub and GitLab.
...
* [Shuffle](https://github.com/frikky/Shuffle) ⭐ 2,442 | 🐛 494 | 🌐 JavaScript | 📅 2026-09-22 - A general purpose security automation platform focused on accessibility.
...
* [NullSec Linux](https://github.com/bad-antics/nullsec-linux) ⭐ 83 | 🐛 2 | 🌐 Shell | 📅 2026-04-17 - Security-focused Linux distribution with 140+ pre-installed forensic and offensive security tools, custom hardened kernel, and integrated incident response workflows.
...
* [Sigma](https://github.com/SigmaHQ/sigma) ⭐ 11,079 | 🐛 220 | 🌐 Python | 📅 2026-09-22 - Generic signature format for SIEM systems already containing an extensive ruleset.
* [Chainsaw](https://github.com/countercept/chainsaw) ⭐ 3,670 | 🐛 6 | 🌐 Rust | 📅 2026-08-25 - Chainsaw provides a powerful ‘first-response’ capability to quickly identify threats within Windows event logs.
* [Hayabusa](https://github.com/Yamato-Security/hayabusa) ⭐ 3,362 | 🐛 18 | 🌐 Rust | 📅 2026-09-12 - Hayabusa is a Windows event log fast forensics timeline generator and threat hunting tool created by the Yamato Security group in Japan.
...
* [Zircolite](https://github.com/wagga40/Zircolite) ⭐ 853 | 🐛 0 | 🌐 Python | 📅 2026-09-20 - A standalone and fast SIGMA-based detection tool for EVTX or JSON.
...
* [WELA](https://github.com/Yamato-Security/WELA) ⭐ 121 | 🐛 36 | 🌐 PowerShell | 📅 2026-09-22 - Windows Event Log Analyzer aims to be the Swiss Army knife for Windows event logs.
...
* [Volatility 3](https://github.com/volatilityfoundation/volatility3) ⭐ 4,424 | 🐛 139 | 🌐 Python | 📅 2026-09-17 - The volatile memory extraction framework (successor of Volatility)
...
* [Didier Stevens Suite](https://github.com/DidierStevens/DidierStevensSuite) ⭐ 2,540 | 🐛 13 | 🌐 Python | 📅 2026-07-30 - Tool collection
...
* [sysmon-modular](https://github.com/olafhartong/sysmon-modular) ⭐ 3,138 | 🐛 50 | 🌐 Go | 📅 2026-09-18 - A repository of sysmon configuration modules
...
* [Hindsight](https://github.com/obsidianforensics/hindsight) ⭐ 1,515 | 🐛 37 | 🌐 Python | 📅 2026-09-19 - Internet history forensics for Google Chrome/Chromium.
...
* [ThreatHunter-Playbook](https://github.com/OTRF/ThreatHunter-Playbook) ⭐ 4,674 | 🐛 6 | 🌐 Python | 📅 2026-01-12 - Playbook to aid the development of techniques and hypothesis for hunting campaigns.
...
* [Ghidra](https://github.com/NationalSecurityAgency/ghidra) ⭐ 79,411 | 🐛 1,964 | 🌐 Java | 📅 2026-09-21 - Software Reverse Engineering Framework.
* [Radare2](https://github.com/radareorg/radare2) ⭐ 24,855 | 🐛 822 | 🌐 C | 📅 2026-09-22 - Reverse engineering framework and command-line toolset.
* [Cutter](https://github.com/rizinorg/cutter) ⭐ 19,784 | 🐛 494 | 🌐 C++ | 📅 2026-09-11 - Free and Open Source Reverse Engineering Platform powered by rizin.
...
* [Rizin](https://github.com/rizinorg/rizin) ⭐ 3,909 | 🐛 589 | 🌐 C | 📅 2026-09-21 - UNIX-like reverse engineering framework and command-line toolset
* [CAPEv2](https://github.com/kevoreilly/CAPEv2) ⭐ 3,526 | 🐛 71 | 🌐 Python | 📅 2026-09-22 - Malware Configuration And Payload Extraction.
