...
* [Atomic Red Team (ART)](https://github.com/redcanaryco/atomic-red-team) ⭐ 12,409 | 🐛 30 | 🌐 C | 📅 2026-08-13 - Small and highly portable detection tests mapped to the MITRE ATT\&CK Framework.
...
* [Flare](https://github.com/fireeye/flare-vm) ⭐ 8,934 | 🐛 27 | 🌐 PowerShell | 📅 2026-06-23 - A fully customizable, Windows-based security distribution for malware analysis, incident response, penetration testing.
* [Fleetdm](https://github.com/fleetdm/fleet) ⭐ 6,711 | 🐛 3,397 | 🌐 Go | 📅 2026-08-14 - State of the art host monitoring platform tailored for security experts. Leveraging Facebook's battle-tested osquery project, Fleetdm delivers continuous updates, features and fast answers to big questions.
...
* [Zentral](https://github.com/zentralopensource/zentral) ⭐ 875 | 🐛 28 | 🌐 Python | 📅 2026-08-14 - Combines osquery's powerful endpoint inventory features with a flexible notification and action framework. This enables one to identify and react to changes on OS X and Linux clients.
...
* [Cynative](https://github.com/cynative/cynative) ⭐ 189 | 🐛 15 | 🌐 Go | 📅 2026-08-14 - Deep research agent for your infra - sandboxed, read-only, covers AWS, GCP, Azure, K8s, GitHub and GitLab.
...
* [CyLR](https://github.com/orlikoski/CyLR) ⭐ 732 | 🐛 21 | 🌐 C# | 📅 2022-06-01 - The CyLR tool collects forensic artifacts from hosts with NTFS file systems quickly, securely and minimizes impact to the host.
...
* [Shuffle](https://github.com/frikky/Shuffle) ⭐ 2,411 | 🐛 490 | 🌐 JavaScript | 📅 2026-08-14 - A general purpose security automation platform focused on accessibility.
...
* [DFTimewolf](https://github.com/log2timeline/dftimewolf) ⭐ 352 | 🐛 5 | 🌐 Python | 📅 2026-08-10 - A framework for orchestrating forensic collection, processing and data export.
...
* [Sigma](https://github.com/SigmaHQ/sigma) ⭐ 10,887 | 🐛 194 | 🌐 Python | 📅 2026-08-13 - Generic signature format for SIEM systems already containing an extensive ruleset.
* [Chainsaw](https://github.com/countercept/chainsaw) ⭐ 3,629 | 🐛 4 | 🌐 Rust | 📅 2026-08-04 - Chainsaw provides a powerful ‘first-response’ capability to quickly identify threats within Windows event logs.
* [Hayabusa](https://github.com/Yamato-Security/hayabusa) ⭐ 3,307 | 🐛 20 | 🌐 Rust | 📅 2026-08-03 - Hayabusa is a Windows event log fast forensics timeline generator and threat hunting tool created by the Yamato Security group in Japan.
* [LogonTracer](https://github.com/JPCERTCC/LogonTracer) ⭐ 3,211 | 🐛 21 | 🌐 Python | 📅 2026-08-02 - Tool to investigate malicious Windows logon by visualizing and analyzing Windows event log.
...
* [Zircolite](https://github.com/wagga40/Zircolite) ⭐ 845 | 🐛 0 | 🌐 Python | 📅 2026-08-05 - A standalone and fast SIGMA-based detection tool for EVTX or JSON.
...
* [Volatility 3](https://github.com/volatilityfoundation/volatility3) ⭐ 4,326 | 🐛 134 | 🌐 Python | 📅 2026-08-14 - The volatile memory extraction framework (successor of Volatility)
...
* [AVML](https://github.com/microsoft/avml) ⭐ 1,118 | 🐛 5 | 🌐 Rust | 📅 2026-08-14 - A portable volatile memory acquisition tool for Linux.
...
* [macOS Artifact Parsing Tool (mac\_apt)](https://github.com/ydkhatri/mac_apt) ⭐ 1,073 | 🐛 7 | 🌐 Python | 📅 2026-07-23 - Plugin based forensics framework for quick mac triage that works on live machines, disk images or individual artifact files.
...
* [Awesome Forensics](https://github.com/cugu/awesome-forensics) ⭐ 5,158 | 🐛 5 | 📅 2026-05-14 - A curated list of awesome forensic analysis tools and resources.
...
* [sysmon-modular](https://github.com/olafhartong/sysmon-modular) ⭐ 3,113 | 🐛 49 | 🌐 PowerShell | 📅 2026-08-10 - A repository of sysmon configuration modules
...
* [Ghidra](https://github.com/NationalSecurityAgency/ghidra) ⭐ 72,371 | 🐛 1,908 | 🌐 Java | 📅 2026-08-13 - Software Reverse Engineering Framework.
* [Radare2](https://github.com/radareorg/radare2) ⭐ 24,568 | 🐛 822 | 🌐 C | 📅 2026-08-14 - Reverse engineering framework and command-line toolset.
* [Cutter](https://github.com/rizinorg/cutter) ⭐ 19,465 | 🐛 491 | 🌐 C++ | 📅 2026-08-13 - Free and Open Source Reverse Engineering Platform powered by rizin.
* [CAPA](https://github.com/mandiant/capa) ⭐ 6,134 | 🐛 287 | 🌐 Python | 📅 2026-08-14 - detects capabilities in executable files. You run it against a PE, ELF, .NET module, or shellcode file and it tells you what it thinks the program can do.
* [Cuckoo](https://github.com/cuckoosandbox/cuckoo) ⚠️ Archived - Open Source Highly configurable sandboxing tool.
* [Rizin](https://github.com/rizinorg/rizin) ⭐ 3,777 | 🐛 541 | 🌐 C | 📅 2026-08-14 - UNIX-like reverse engineering framework and command-line toolset
* [CAPEv2](https://github.com/kevoreilly/CAPEv2) ⭐ 3,420 | 🐛 49 | 🌐 Python | 📅 2026-08-14 - Malware Configuration And Payload Extraction.
...
* [LOKI](https://github.com/Neo23x0/Loki) ⭐ 3,776 | 🐛 18 | 🌐 Python | 📅 2026-01-12 - Free IR scanner for scanning endpoint with yara rules and other indicators(IOCs).
...
* [Plaso](https://github.com/log2timeline/plaso) ⭐ 2,136 | 🐛 280 | 🌐 Python | 📅 2026-08-03 -  a Python-based backend engine for the tool log2timeline.
