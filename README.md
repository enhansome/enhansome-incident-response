...
* [Atomic Red Team (ART)](https://github.com/redcanaryco/atomic-red-team) ⭐ 12,517 | 🐛 33 | 🌐 C | 📅 2026-09-05 - Small and highly portable detection tests mapped to the MITRE ATT\&CK Framework.
* [Caldera](https://github.com/mitre/caldera) ⭐ 7,252 | 🐛 71 | 🌐 Python | 📅 2026-08-27 - Automated adversary emulation system that performs post-compromise adversarial behavior within Windows Enterprise networks. It generates plans during operation using a planning system and a pre-configured adversary model based on the Adversarial Tactics, Techniques & Common Knowledge (ATT\&CK™) project.
* [APTSimulator](https://github.com/NextronSystems/APTSimulator) ⭐ 2,768 | 🐛 4 | 🌐 Batchfile | 📅 2025-09-23 - Windows Batch script that uses a set of tools and output files to make a system look as if it was compromised.
...
* [DumpsterFire](https://github.com/TryCatchHCF/DumpsterFire) ⭐ 1,039 | 🐛 5 | 🌐 Python | 📅 2020-05-27 - Modular, menu-driven, cross-platform tool for building repeatable, time-delayed, distributed security events. Easily create custom event chains for Blue Team drills and sensor /   alert mapping. Red Teams can create decoy incidents, distractions, and lures to support and scale their operations.
...
* [Flare](https://github.com/fireeye/flare-vm) ⭐ 9,017 | 🐛 28 | 🌐 PowerShell | 📅 2026-06-23 - A fully customizable, Windows-based security distribution for malware analysis, incident response, penetration testing.
* [Fleetdm](https://github.com/fleetdm/fleet) ⭐ 6,831 | 🐛 3,515 | 🌐 Go | 📅 2026-09-10 - State of the art host monitoring platform tailored for security experts. Leveraging Facebook's battle-tested osquery project, Fleetdm delivers continuous updates, features and fast answers to big questions.
...
* [IRIS](https://github.com/dfir-iris/iris-web) ⭐ 1,559 | 🐛 431 | 🌐 Python | 📅 2026-08-24 - IRIS is a web collaborative platform for incident response analysts allowing to share investigations at a technical level.
* [Dissect](https://github.com/fox-it/dissect) ⭐ 1,152 | 🐛 13 | 📅 2026-09-10 - Dissect is a digital forensics & incident response framework and toolset that allows you to quickly access and analyse forensic artefacts from various disk and file formats, developed by Fox-IT (part of NCC Group).
* [Kuiper](https://github.com/DFIRKuiper/Kuiper) ⭐ 905 | 🐛 12 | 🌐 JavaScript | 📅 2024-10-12 - Digital Forensics Investigation Platform
* [Zentral](https://github.com/zentralopensource/zentral) ⭐ 880 | 🐛 37 | 🌐 Python | 📅 2026-09-10 - Combines osquery's powerful endpoint inventory features with a flexible notification and action framework. This enables one to identify and react to changes on OS X and Linux clients.
...
* [Cynative](https://github.com/cynative/cynative) ⭐ 200 | 🐛 19 | 🌐 Go | 📅 2026-09-10 - Deep research agent for your infra - sandboxed, read-only, covers AWS, GCP, Azure, K8s, GitHub and GitLab.
...
* [UAC](https://github.com/tclahr/uac) ⭐ 1,450 | 🐛 7 | 🌐 Shell | 📅 2026-09-09 - UAC (Unix-like Artifacts Collector) is a Live Response collection script for Incident Response that makes use of native binaries and tools to automate the collection of AIX, Android, ESXi, FreeBSD, Linux, macOS, NetBSD, NetScaler, OpenBSD and Solaris systems artifacts.
* [bulk\_extractor](https://github.com/simsong/bulk_extractor) ⭐ 1,420 | 🐛 67 | 🌐 C++ | 📅 2026-09-01 - Computer forensics tool that scans a disk image, a file, or a directory of files and extracts useful information without parsing the file system or file system structures. Because of ignoring the file system structure, the program distinguishes itself in terms of speed and thoroughness.
...
* [Shuffle](https://github.com/frikky/Shuffle) ⭐ 2,431 | 🐛 491 | 🌐 JavaScript | 📅 2026-09-10 - A general purpose security automation platform focused on accessibility.
...
* [Windows Events Attack Samples](https://github.com/sbousseaden/EVTX-ATTACK-SAMPLES) ⭐ 2,624 | 🐛 5 | 🌐 HTML | 📅 2023-01-24 - Windows Events Attack Samples
* [Windows Registry Knowledge Base](https://github.com/libyal/winreg-kb) ⭐ 204 | 🐛 5 | 🌐 Python | 📅 2026-07-30 - Windows Registry Knowledge Base
...
* [Sigma](https://github.com/SigmaHQ/sigma) ⭐ 11,018 | 🐛 203 | 🌐 Python | 📅 2026-09-07 - Generic signature format for SIEM systems already containing an extensive ruleset.
...
* [Hayabusa](https://github.com/Yamato-Security/hayabusa) ⭐ 3,341 | 🐛 19 | 🌐 Rust | 📅 2026-09-05 - Hayabusa is a Windows event log fast forensics timeline generator and threat hunting tool created by the Yamato Security group in Japan.
...
* [Zircolite](https://github.com/wagga40/Zircolite) ⭐ 850 | 🐛 0 | 🌐 Python | 📅 2026-08-24 - A standalone and fast SIGMA-based detection tool for EVTX or JSON.
...
* [Volatility 3](https://github.com/volatilityfoundation/volatility3) ⭐ 4,382 | 🐛 138 | 🌐 Python | 📅 2026-09-09 - The volatile memory extraction framework (successor of Volatility)
* \[MemProcFS] (<https://github.com/ufrisk/MemProcFS> ⭐ 4,324 | 🐛 4 | 🌐 C | 📅 2026-09-08) - MemProcFS is an easy and convenient way of viewing physical memory as files in a virtual file system.
* [LiME](https://github.com/504ensicsLabs/LiME) ⭐ 2,032 | 🐛 35 | 🌐 C | 📅 2026-04-05 - Loadable Kernel Module (LKM), which allows the acquisition of volatile memory from Linux and Linux-based devices, formerly called DMD.
...
* [Orochi](https://github.com/LDO-CERT/orochi) ⭐ 275 | 🐛 69 | 🌐 JavaScript | 📅 2026-09-10 - Orochi is an open source framework for collaborative forensic memory dump analysis.
...
* [OSX Auditor](https://github.com/jipegit/OSXAuditor) ⭐ 3,132 | 🐛 8 | 🌐 JavaScript | 📅 2020-07-27 - Free Mac OS X computer forensics tool.
* [OSX Collector](https://github.com/yelp/osxcollector) ⚠️ Archived - OSX Auditor offshoot for live response.
* [macOS Artifact Parsing Tool (mac\_apt)](https://github.com/ydkhatri/mac_apt) ⭐ 1,081 | 🐛 9 | 🌐 Python | 📅 2026-08-21 - Plugin based forensics framework for quick mac triage that works on live machines, disk images or individual artifact files.
...
* [sysmon-modular](https://github.com/olafhartong/sysmon-modular) ⭐ 3,129 | 🐛 49 | 🌐 PowerShell | 📅 2026-09-09 - A repository of sysmon configuration modules
...
* [Hindsight](https://github.com/obsidianforensics/hindsight) ⭐ 1,505 | 🐛 36 | 🌐 Python | 📅 2026-09-07 - Internet history forensics for Google Chrome/Chromium.
* [Raccine](https://github.com/Neo23x0/Raccine) ⭐ 983 | 🐛 21 | 🌐 C++ | 📅 2023-11-08 - A Simple Ransomware Protection
* [Munin](https://github.com/Neo23x0/munin) ⭐ 852 | 🐛 30 | 🌐 Python | 📅 2026-09-09 - Online hash checker for VirusTotal and other services.
...
* [rastrea2r](https://github.com/rastrea2r/rastrea2r) ⭐ 239 | 🐛 8 | 🌐 Python | 📅 2021-08-01 - Allows one to scan disks and memory for IOCs using YARA on Windows, Linux and OS X.
...
* [ThreatHunter-Playbook](https://github.com/OTRF/ThreatHunter-Playbook) ⭐ 4,656 | 🐛 6 | 🌐 Python | 📅 2026-01-12 - Playbook to aid the development of techniques and hypothesis for hunting campaigns.
* [IRM](https://github.com/certsocietegenerale/IRM) ⭐ 1,141 | 🐛 0 | 📅 2025-04-11 - Incident Response Methodologies by CERT Societe Generale.
* [AWS Incident Response Runbook Samples](https://github.com/aws-samples/aws-incident-response-runbooks/tree/0d9a1c0f7ad68fb2c1b2d86be8914f2069492e21) ⭐ 1,107 | 🐛 1 | 📅 2026-08-28 - AWS IR Runbook Samples meant to be customized per each entity using them. The three samples are: "DoS or DDoS attack", "credential leakage", and "unintended access to an Amazon S3 bucket".
...
* [Ghidra](https://github.com/NationalSecurityAgency/ghidra) ⭐ 74,769 | 🐛 1,947 | 🌐 Java | 📅 2026-09-08 - Software Reverse Engineering Framework.
* [Radare2](https://github.com/radareorg/radare2) ⭐ 24,777 | 🐛 819 | 🌐 C | 📅 2026-09-10 - Reverse engineering framework and command-line toolset.
* [Cutter](https://github.com/rizinorg/cutter) ⭐ 19,713 | 🐛 493 | 🌐 C++ | 📅 2026-08-22 - Free and Open Source Reverse Engineering Platform powered by rizin.
* [CAPA](https://github.com/mandiant/capa) ⭐ 6,179 | 🐛 299 | 🌐 Python | 📅 2026-09-08 - detects capabilities in executable files. You run it against a PE, ELF, .NET module, or shellcode file and it tells you what it thinks the program can do.
* [Cuckoo](https://github.com/cuckoosandbox/cuckoo) ⚠️ Archived - Open Source Highly configurable sandboxing tool.
* [Rizin](https://github.com/rizinorg/rizin) ⭐ 3,886 | 🐛 564 | 🌐 C | 📅 2026-09-10 - UNIX-like reverse engineering framework and command-line toolset
* [CAPEv2](https://github.com/kevoreilly/CAPEv2) ⭐ 3,484 | 🐛 53 | 🌐 Python | 📅 2026-09-10 - Malware Configuration And Payload Extraction.
...
* [Timesketch](https://github.com/google/timesketch) ⭐ 3,411 | 🐛 215 | 🌐 Python | 📅 2026-09-08 - Open source tool for collaborative forensic timeline analysis.
* [Plaso](https://github.com/log2timeline/plaso) ⭐ 2,152 | 🐛 276 | 🌐 Python | 📅 2026-08-28 -  a Python-based backend engine for the tool log2timeline.
* [Aurora Incident Response](https://github.com/cyb3rfox/Aurora-Incident-Response) ⭐ 1,080 | 🐛 41 | 🌐 JavaScript | 📅 2023-10-05 - Platform developed to build easily a detailed timeline of an incident.
...
* [LOKI](https://github.com/Neo23x0/Loki) ⭐ 3,789 | 🐛 18 | 🌐 Python | 📅 2026-01-12 - Free IR scanner for scanning endpoint with yara rules and other indicators(IOCs).
* [Fibratus](https://github.com/rabbitstack/fibratus) ⭐ 2,541 | 🐛 45 | 🌐 Go | 📅 2026-09-10 - Tool for exploration and tracing of the Windows kernel.
