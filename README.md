...
* [Atomic Red Team (ART)](https://github.com/redcanaryco/atomic-red-team) ⭐ 12,476 | 🐛 32 | 🌐 C | 📅 2026-08-31 - Small and highly portable detection tests mapped to the MITRE ATT\&CK Framework.
* [Caldera](https://github.com/mitre/caldera) ⭐ 7,231 | 🐛 71 | 🌐 Python | 📅 2026-08-27 - Automated adversary emulation system that performs post-compromise adversarial behavior within Windows Enterprise networks. It generates plans during operation using a planning system and a pre-configured adversary model based on the Adversarial Tactics, Techniques & Common Knowledge (ATT\&CK™) project.
...
* [DumpsterFire](https://github.com/TryCatchHCF/DumpsterFire) ⭐ 1,040 | 🐛 4 | 🌐 Python | 📅 2020-05-27 - Modular, menu-driven, cross-platform tool for building repeatable, time-delayed, distributed security events. Easily create custom event chains for Blue Team drills and sensor /   alert mapping. Red Teams can create decoy incidents, distractions, and lures to support and scale their operations.
...
* [Flare](https://github.com/fireeye/flare-vm) ⭐ 8,983 | 🐛 28 | 🌐 PowerShell | 📅 2026-06-23 - A fully customizable, Windows-based security distribution for malware analysis, incident response, penetration testing.
* [Fleetdm](https://github.com/fleetdm/fleet) ⭐ 6,800 | 🐛 3,536 | 🌐 Go | 📅 2026-09-01 - State of the art host monitoring platform tailored for security experts. Leveraging Facebook's battle-tested osquery project, Fleetdm delivers continuous updates, features and fast answers to big questions.
...
* [Velociraptor](https://github.com/Velocidex/velociraptor) ⭐ 4,225 | 🐛 76 | 🌐 Go | 📅 2026-08-25 - Endpoint visibility and collection tool
...
* [IRIS](https://github.com/dfir-iris/iris-web) ⭐ 1,556 | 🐛 427 | 🌐 Python | 📅 2026-08-24 - IRIS is a web collaborative platform for incident response analysts allowing to share investigations at a technical level.
* [Dissect](https://github.com/fox-it/dissect) ⭐ 1,150 | 🐛 10 | 📅 2026-02-25 - Dissect is a digital forensics & incident response framework and toolset that allows you to quickly access and analyse forensic artefacts from various disk and file formats, developed by Fox-IT (part of NCC Group).
* [Kuiper](https://github.com/DFIRKuiper/Kuiper) ⭐ 905 | 🐛 12 | 🌐 JavaScript | 📅 2024-10-12 - Digital Forensics Investigation Platform
* [Zentral](https://github.com/zentralopensource/zentral) ⭐ 879 | 🐛 34 | 🌐 Python | 📅 2026-09-01 - Combines osquery's powerful endpoint inventory features with a flexible notification and action framework. This enables one to identify and react to changes on OS X and Linux clients.
...
* [Cynative](https://github.com/cynative/cynative) ⭐ 194 | 🐛 18 | 🌐 Go | 📅 2026-09-01 - Deep research agent for your infra - sandboxed, read-only, covers AWS, GCP, Azure, K8s, GitHub and GitLab.
...
* [UAC](https://github.com/tclahr/uac) ⭐ 1,441 | 🐛 9 | 🌐 Shell | 📅 2026-08-25 - UAC (Unix-like Artifacts Collector) is a Live Response collection script for Incident Response that makes use of native binaries and tools to automate the collection of AIX, Android, ESXi, FreeBSD, Linux, macOS, NetBSD, NetScaler, OpenBSD and Solaris systems artifacts.
* [bulk\_extractor](https://github.com/simsong/bulk_extractor) ⭐ 1,416 | 🐛 67 | 🌐 C++ | 📅 2026-09-01 - Computer forensics tool that scans a disk image, a file, or a directory of files and extracts useful information without parsing the file system or file system structures. Because of ignoring the file system structure, the program distinguishes itself in terms of speed and thoroughness.
* [Forensic Artifacts](https://github.com/ForensicArtifacts/artifacts) ⭐ 1,270 | 🐛 44 | 🌐 Python | 📅 2026-07-31 - Digital Forensics Artifact Repository
...
* [Shuffle](https://github.com/frikky/Shuffle) ⭐ 2,423 | 🐛 491 | 🌐 JavaScript | 📅 2026-09-01 - A general purpose security automation platform focused on accessibility.
* [Fast Incident Response (FIR)](https://github.com/certsocietegenerale/FIR/) ⭐ 2,033 | 🐛 13 | 🌐 JavaScript | 📅 2026-08-31 - Cybersecurity incident management platform designed with agility and speed in mind. It allows for easy creation, tracking, and reporting of cybersecurity incidents and is useful for CSIRTs, CERTs and SOCs alike.
...
* [DFTimewolf](https://github.com/log2timeline/dftimewolf) ⭐ 353 | 🐛 4 | 🌐 Python | 📅 2026-08-27 - A framework for orchestrating forensic collection, processing and data export.
...
* [Windows Events Attack Samples](https://github.com/sbousseaden/EVTX-ATTACK-SAMPLES) ⭐ 2,618 | 🐛 5 | 🌐 HTML | 📅 2023-01-24 - Windows Events Attack Samples
...
* [Sigma](https://github.com/SigmaHQ/sigma) ⭐ 10,968 | 🐛 204 | 🌐 Python | 📅 2026-09-01 - Generic signature format for SIEM systems already containing an extensive ruleset.
* [Chainsaw](https://github.com/countercept/chainsaw) ⭐ 3,652 | 🐛 4 | 🌐 Rust | 📅 2026-08-25 - Chainsaw provides a powerful ‘first-response’ capability to quickly identify threats within Windows event logs.
* [Hayabusa](https://github.com/Yamato-Security/hayabusa) ⭐ 3,331 | 🐛 19 | 🌐 Rust | 📅 2026-08-28 - Hayabusa is a Windows event log fast forensics timeline generator and threat hunting tool created by the Yamato Security group in Japan.
* [LogonTracer](https://github.com/JPCERTCC/LogonTracer) ⭐ 3,225 | 🐛 21 | 🌐 Python | 📅 2026-08-02 - Tool to investigate malicious Windows logon by visualizing and analyzing Windows event log.
* [StreamAlert](https://github.com/airbnb/streamalert) ⭐ 2,888 | 🐛 90 | 🌐 Python | 📅 2023-10-23 - Serverless, real-time log data analysis framework, capable of ingesting custom data sources and triggering alerts using user-defined logic.
...
* [Logdissect](https://github.com/dogoncouch/logdissect) ⭐ 160 | 🐛 3 | 🌐 Python | 📅 2024-08-07 - CLI utility and Python API for analyzing log files and other data.
* [WELA](https://github.com/Yamato-Security/WELA) ⭐ 120 | 🐛 6 | 🌐 PowerShell | 📅 2026-09-01 - Windows Event Log Analyzer aims to be the Swiss Army knife for Windows event logs.
...
* [Volatility 3](https://github.com/volatilityfoundation/volatility3) ⭐ 4,366 | 🐛 135 | 🌐 Python | 📅 2026-08-19 - The volatile memory extraction framework (successor of Volatility)
* \[MemProcFS] (<https://github.com/ufrisk/MemProcFS> ⭐ 4,310 | 🐛 9 | 🌐 C | 📅 2026-08-25) - MemProcFS is an easy and convenient way of viewing physical memory as files in a virtual file system.
...
* [Orochi](https://github.com/LDO-CERT/orochi) ⭐ 275 | 🐛 92 | 🌐 JavaScript | 📅 2026-09-01 - Orochi is an open source framework for collaborative forensic memory dump analysis.
...
* [macOS Artifact Parsing Tool (mac\_apt)](https://github.com/ydkhatri/mac_apt) ⭐ 1,079 | 🐛 8 | 🌐 Python | 📅 2026-08-21 - Plugin based forensics framework for quick mac triage that works on live machines, disk images or individual artifact files.
...
* [Didier Stevens Suite](https://github.com/DidierStevens/DidierStevensSuite) ⭐ 2,528 | 🐛 13 | 🌐 Python | 📅 2026-07-30 - Tool collection
* [List of various Security APIs](https://github.com/deralexxx/security-apis) ⭐ 990 | 🐛 2 | 📅 2026-09-01 - Collective list of public JSON APIs for use in security.
...
* [sysmon-modular](https://github.com/olafhartong/sysmon-modular) ⭐ 3,124 | 🐛 49 | 🌐 PowerShell | 📅 2026-08-31 - A repository of sysmon configuration modules
...
* [Hindsight](https://github.com/obsidianforensics/hindsight) ⭐ 1,499 | 🐛 6 | 🌐 Python | 📅 2026-09-01 - Internet history forensics for Google Chrome/Chromium.
...
* [ThreatHunter-Playbook](https://github.com/OTRF/ThreatHunter-Playbook) ⭐ 4,649 | 🐛 6 | 🌐 Python | 📅 2026-01-12 - Playbook to aid the development of techniques and hypothesis for hunting campaigns.
* [IRM](https://github.com/certsocietegenerale/IRM) ⭐ 1,141 | 🐛 0 | 📅 2025-04-11 - Incident Response Methodologies by CERT Societe Generale.
* [AWS Incident Response Runbook Samples](https://github.com/aws-samples/aws-incident-response-runbooks/tree/0d9a1c0f7ad68fb2c1b2d86be8914f2069492e21) ⭐ 1,102 | 🐛 1 | 📅 2026-08-28 - AWS IR Runbook Samples meant to be customized per each entity using them. The three samples are: "DoS or DDoS attack", "credential leakage", and "unintended access to an Amazon S3 bucket".
...
* [Counteractive Playbooks](https://github.com/counteractive/incident-response-plan-template/tree/master/playbooks) ⭐ 802 | 🐛 5 | 🌐 Makefile | 📅 2024-05-07 - Counteractive PLaybooks collection.
* [Phantom Community Playbooks](https://github.com/phantomcyber/playbooks) ⭐ 551 | 🐛 17 | 🌐 Python | 📅 2026-09-01 - Phantom Community Playbooks for Splunk but also customizable for other use.
...
* [Ghidra](https://github.com/NationalSecurityAgency/ghidra) ⭐ 74,222 | 🐛 1,921 | 🌐 Java | 📅 2026-09-01 - Software Reverse Engineering Framework.
* [Radare2](https://github.com/radareorg/radare2) ⭐ 24,703 | 🐛 824 | 🌐 C | 📅 2026-09-01 - Reverse engineering framework and command-line toolset.
* [Cutter](https://github.com/rizinorg/cutter) ⭐ 19,651 | 🐛 494 | 🌐 C++ | 📅 2026-08-22 - Free and Open Source Reverse Engineering Platform powered by rizin.
* [CAPA](https://github.com/mandiant/capa) ⭐ 6,162 | 🐛 298 | 🌐 Python | 📅 2026-09-01 - detects capabilities in executable files. You run it against a PE, ELF, .NET module, or shellcode file and it tells you what it thinks the program can do.
* [Cuckoo](https://github.com/cuckoosandbox/cuckoo) ⚠️ Archived - Open Source Highly configurable sandboxing tool.
* [Rizin](https://github.com/rizinorg/rizin) ⭐ 3,836 | 🐛 552 | 🌐 C | 📅 2026-09-01 - UNIX-like reverse engineering framework and command-line toolset
* [CAPEv2](https://github.com/kevoreilly/CAPEv2) ⭐ 3,462 | 🐛 59 | 🌐 Python | 📅 2026-09-01 - Malware Configuration And Payload Extraction.
...
* [LOKI](https://github.com/Neo23x0/Loki) ⭐ 3,786 | 🐛 18 | 🌐 Python | 📅 2026-01-12 - Free IR scanner for scanning endpoint with yara rules and other indicators(IOCs).
* [Fenrir](https://github.com/Neo23x0/Fenrir) ⭐ 775 | 🐛 1 | 🌐 Shell | 📅 2022-02-12 - Simple IOC scanner. It allows scanning any Linux/Unix/OSX system for IOCs in plain bash. Created by the creators of THOR and LOKI.
* [Spyre](https://github.com/spyre-project/spyre) ⭐ 181 | 🐛 13 | 🌐 Go | 📅 2026-03-17 - Simple YARA-based IOC scanner written in Go

### Timeline Tools

* [Timesketch](https://github.com/google/timesketch) ⭐ 3,401 | 🐛 219 | 🌐 Python | 📅 2026-08-24 - Open source tool for collaborative forensic timeline analysis.
* [Plaso](https://github.com/log2timeline/plaso) ⭐ 2,144 | 🐛 275 | 🌐 Python | 📅 2026-08-28 -  a Python-based backend engine for the tool log2timeline.
