...
* [Atomic Red Team (ART)](https://github.com/redcanaryco/atomic-red-team) ⭐ 12,458 | 🐛 31 | 🌐 C | 📅 2026-08-24 - Small and highly portable detection tests mapped to the MITRE ATT\&CK Framework.
* [Caldera](https://github.com/mitre/caldera) ⭐ 7,213 | 🐛 69 | 🌐 Python | 📅 2026-08-27 - Automated adversary emulation system that performs post-compromise adversarial behavior within Windows Enterprise networks. It generates plans during operation using a planning system and a pre-configured adversary model based on the Adversarial Tactics, Techniques & Common Knowledge (ATT\&CK™) project.
...
* [Flare](https://github.com/fireeye/flare-vm) ⭐ 8,969 | 🐛 28 | 🌐 PowerShell | 📅 2026-06-23 - A fully customizable, Windows-based security distribution for malware analysis, incident response, penetration testing.
* [Fleetdm](https://github.com/fleetdm/fleet) ⭐ 6,781 | 🐛 3,502 | 🌐 Go | 📅 2026-08-27 - State of the art host monitoring platform tailored for security experts. Leveraging Facebook's battle-tested osquery project, Fleetdm delivers continuous updates, features and fast answers to big questions.
...
* [IRIS](https://github.com/dfir-iris/iris-web) ⭐ 1,549 | 🐛 423 | 🌐 Python | 📅 2026-08-24 - IRIS is a web collaborative platform for incident response analysts allowing to share investigations at a technical level.
...
* [Kuiper](https://github.com/DFIRKuiper/Kuiper) ⭐ 903 | 🐛 12 | 🌐 JavaScript | 📅 2024-10-12 - Digital Forensics Investigation Platform
* [Zentral](https://github.com/zentralopensource/zentral) ⭐ 879 | 🐛 35 | 🌐 Python | 📅 2026-08-27 - Combines osquery's powerful endpoint inventory features with a flexible notification and action framework. This enables one to identify and react to changes on OS X and Linux clients.
...
* [Forensic Artifacts](https://github.com/ForensicArtifacts/artifacts) ⭐ 1,269 | 🐛 44 | 🌐 Python | 📅 2026-07-31 - Digital Forensics Artifact Repository
...
* [Shuffle](https://github.com/frikky/Shuffle) ⭐ 2,421 | 🐛 491 | 🌐 JavaScript | 📅 2026-08-27 - A general purpose security automation platform focused on accessibility.
* [Fast Incident Response (FIR)](https://github.com/certsocietegenerale/FIR/) ⭐ 2,032 | 🐛 15 | 🌐 JavaScript | 📅 2026-08-07 - Cybersecurity incident management platform designed with agility and speed in mind. It allows for easy creation, tracking, and reporting of cybersecurity incidents and is useful for CSIRTs, CERTs and SOCs alike.
...
* [Sigma](https://github.com/SigmaHQ/sigma) ⭐ 10,947 | 🐛 204 | 🌐 Python | 📅 2026-08-18 - Generic signature format for SIEM systems already containing an extensive ruleset.
...
* [LogonTracer](https://github.com/JPCERTCC/LogonTracer) ⭐ 3,222 | 🐛 21 | 🌐 Python | 📅 2026-08-02 - Tool to investigate malicious Windows logon by visualizing and analyzing Windows event log.
...
* \[MemProcFS] (<https://github.com/ufrisk/MemProcFS> ⭐ 4,302 | 🐛 9 | 🌐 C | 📅 2026-08-25) - MemProcFS is an easy and convenient way of viewing physical memory as files in a virtual file system.
...
* [Hindsight](https://github.com/obsidianforensics/hindsight) ⭐ 1,499 | 🐛 7 | 🌐 Python | 📅 2026-08-23 - Internet history forensics for Google Chrome/Chromium.
...
* [Ghidra](https://github.com/NationalSecurityAgency/ghidra) ⭐ 72,928 | 🐛 1,921 | 🌐 Java | 📅 2026-08-25 - Software Reverse Engineering Framework.
* [Radare2](https://github.com/radareorg/radare2) ⭐ 24,658 | 🐛 819 | 🌐 C | 📅 2026-08-27 - Reverse engineering framework and command-line toolset.
* [Cutter](https://github.com/rizinorg/cutter) ⭐ 19,595 | 🐛 493 | 🌐 C++ | 📅 2026-08-22 - Free and Open Source Reverse Engineering Platform powered by rizin.
* [CAPA](https://github.com/mandiant/capa) ⭐ 6,157 | 🐛 295 | 🌐 Python | 📅 2026-08-26 - detects capabilities in executable files. You run it against a PE, ELF, .NET module, or shellcode file and it tells you what it thinks the program can do.
* [Cuckoo](https://github.com/cuckoosandbox/cuckoo) ⚠️ Archived - Open Source Highly configurable sandboxing tool.
* [Rizin](https://github.com/rizinorg/rizin) ⭐ 3,806 | 🐛 551 | 🌐 C | 📅 2026-08-26 - UNIX-like reverse engineering framework and command-line toolset
* [CAPEv2](https://github.com/kevoreilly/CAPEv2) ⭐ 3,453 | 🐛 57 | 🌐 Python | 📅 2026-08-23 - Malware Configuration And Payload Extraction.
...
* [Timesketch](https://github.com/google/timesketch) ⭐ 3,397 | 🐛 221 | 🌐 Python | 📅 2026-08-24 - Open source tool for collaborative forensic timeline analysis.
* [Plaso](https://github.com/log2timeline/plaso) ⭐ 2,140 | 🐛 286 | 🌐 Python | 📅 2026-08-27 -  a Python-based backend engine for the tool log2timeline.
