...
* [Atomic Red Team (ART)](https://github.com/redcanaryco/atomic-red-team) ⭐ 12,445 | 🐛 29 | 🌐 C | 📅 2026-08-17 - Small and highly portable detection tests mapped to the MITRE ATT\&CK Framework.
* [Caldera](https://github.com/mitre/caldera) ⭐ 7,211 | 🐛 75 | 🌐 Python | 📅 2026-08-12 - Automated adversary emulation system that performs post-compromise adversarial behavior within Windows Enterprise networks. It generates plans during operation using a planning system and a pre-configured adversary model based on the Adversarial Tactics, Techniques & Common Knowledge (ATT\&CK™) project.
...
* [Flare](https://github.com/fireeye/flare-vm) ⭐ 8,953 | 🐛 28 | 🌐 PowerShell | 📅 2026-06-23 - A fully customizable, Windows-based security distribution for malware analysis, incident response, penetration testing.
* [Fleetdm](https://github.com/fleetdm/fleet) ⭐ 6,763 | 🐛 3,486 | 🌐 Go | 📅 2026-08-23 - State of the art host monitoring platform tailored for security experts. Leveraging Facebook's battle-tested osquery project, Fleetdm delivers continuous updates, features and fast answers to big questions.
...
* [Velociraptor](https://github.com/Velocidex/velociraptor) ⭐ 4,195 | 🐛 74 | 🌐 Go | 📅 2026-08-20 - Endpoint visibility and collection tool
...
* [IRIS](https://github.com/dfir-iris/iris-web) ⭐ 1,544 | 🐛 420 | 🌐 Python | 📅 2026-07-13 - IRIS is a web collaborative platform for incident response analysts allowing to share investigations at a technical level.
* [Dissect](https://github.com/fox-it/dissect) ⭐ 1,148 | 🐛 10 | 📅 2026-02-25 - Dissect is a digital forensics & incident response framework and toolset that allows you to quickly access and analyse forensic artefacts from various disk and file formats, developed by Fox-IT (part of NCC Group).
* [Kuiper](https://github.com/DFIRKuiper/Kuiper) ⭐ 901 | 🐛 12 | 🌐 JavaScript | 📅 2024-10-12 - Digital Forensics Investigation Platform
* [Zentral](https://github.com/zentralopensource/zentral) ⭐ 877 | 🐛 34 | 🌐 Python | 📅 2026-08-23 - Combines osquery's powerful endpoint inventory features with a flexible notification and action framework. This enables one to identify and react to changes on OS X and Linux clients.
...
* [Cynative](https://github.com/cynative/cynative) ⭐ 191 | 🐛 20 | 🌐 Go | 📅 2026-08-23 - Deep research agent for your infra - sandboxed, read-only, covers AWS, GCP, Azure, K8s, GitHub and GitLab.
...
* [Forensic Artifacts](https://github.com/ForensicArtifacts/artifacts) ⭐ 1,267 | 🐛 44 | 🌐 Python | 📅 2026-07-31 - Digital Forensics Artifact Repository
...
* [Shuffle](https://github.com/frikky/Shuffle) ⭐ 2,419 | 🐛 490 | 🌐 JavaScript | 📅 2026-08-19 - A general purpose security automation platform focused on accessibility.
...
* [Windows Events Attack Samples](https://github.com/sbousseaden/EVTX-ATTACK-SAMPLES) ⭐ 2,612 | 🐛 5 | 🌐 HTML | 📅 2023-01-24 - Windows Events Attack Samples
...
* [Sigma](https://github.com/SigmaHQ/sigma) ⭐ 10,929 | 🐛 199 | 🌐 Python | 📅 2026-08-18 - Generic signature format for SIEM systems already containing an extensive ruleset.
* [Chainsaw](https://github.com/countercept/chainsaw) ⭐ 3,642 | 🐛 4 | 🌐 Rust | 📅 2026-08-19 - Chainsaw provides a powerful ‘first-response’ capability to quickly identify threats within Windows event logs.
* [Hayabusa](https://github.com/Yamato-Security/hayabusa) ⭐ 3,321 | 🐛 21 | 🌐 Rust | 📅 2026-08-22 - Hayabusa is a Windows event log fast forensics timeline generator and threat hunting tool created by the Yamato Security group in Japan.
* [LogonTracer](https://github.com/JPCERTCC/LogonTracer) ⭐ 3,218 | 🐛 21 | 🌐 Python | 📅 2026-08-02 - Tool to investigate malicious Windows logon by visualizing and analyzing Windows event log.
...
* [Volatility 3](https://github.com/volatilityfoundation/volatility3) ⭐ 4,350 | 🐛 133 | 🌐 Python | 📅 2026-08-19 - The volatile memory extraction framework (successor of Volatility)
* \[MemProcFS] (<https://github.com/ufrisk/MemProcFS> ⭐ 4,298 | 🐛 9 | 🌐 C | 📅 2026-08-17) - MemProcFS is an easy and convenient way of viewing physical memory as files in a virtual file system.
...
* [Orochi](https://github.com/LDO-CERT/orochi) ⭐ 275 | 🐛 91 | 🌐 JavaScript | 📅 2026-08-17 - Orochi is an open source framework for collaborative forensic memory dump analysis.
...
* [Didier Stevens Suite](https://github.com/DidierStevens/DidierStevensSuite) ⭐ 2,524 | 🐛 13 | 🌐 Python | 📅 2026-07-30 - Tool collection
...
* [Hindsight](https://github.com/obsidianforensics/hindsight) ⭐ 1,492 | 🐛 7 | 🌐 Python | 📅 2026-08-23 - Internet history forensics for Google Chrome/Chromium.
...
* [ThreatHunter-Playbook](https://github.com/OTRF/ThreatHunter-Playbook) ⭐ 4,638 | 🐛 6 | 🌐 Python | 📅 2026-01-12 - Playbook to aid the development of techniques and hypothesis for hunting campaigns.
...
* [Ghidra](https://github.com/NationalSecurityAgency/ghidra) ⭐ 72,703 | 🐛 1,922 | 🌐 Java | 📅 2026-08-20 - Software Reverse Engineering Framework.
* [Radare2](https://github.com/radareorg/radare2) ⭐ 24,627 | 🐛 821 | 🌐 C | 📅 2026-08-23 - Reverse engineering framework and command-line toolset.
* [Cutter](https://github.com/rizinorg/cutter) ⭐ 19,551 | 🐛 493 | 🌐 C++ | 📅 2026-08-22 - Free and Open Source Reverse Engineering Platform powered by rizin.
* [CAPA](https://github.com/mandiant/capa) ⭐ 6,153 | 🐛 291 | 🌐 Python | 📅 2026-08-18 - detects capabilities in executable files. You run it against a PE, ELF, .NET module, or shellcode file and it tells you what it thinks the program can do.
* [Cuckoo](https://github.com/cuckoosandbox/cuckoo) ⚠️ Archived - Open Source Highly configurable sandboxing tool.
* [Rizin](https://github.com/rizinorg/rizin) ⭐ 3,799 | 🐛 548 | 🌐 C | 📅 2026-08-23 - UNIX-like reverse engineering framework and command-line toolset
* [CAPEv2](https://github.com/kevoreilly/CAPEv2) ⭐ 3,441 | 🐛 56 | 🌐 Python | 📅 2026-08-23 - Malware Configuration And Payload Extraction.
...
* [Timesketch](https://github.com/google/timesketch) ⭐ 3,392 | 🐛 217 | 🌐 Python | 📅 2026-08-18 - Open source tool for collaborative forensic timeline analysis.
...
* [RegRipper](https://github.com/keydet89/RegRipper3.0) ⭐ 713 | 🐛 9 | 🌐 Perl | 📅 2026-05-27 - Open source tool, written in Perl, for extracting/parsing information (keys, values, data) from the Registry and presenting it for analysis.
