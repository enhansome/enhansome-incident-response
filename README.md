...
* [Atomic Red Team (ART)](https://github.com/redcanaryco/atomic-red-team) ⭐ 12,433 | 🐛 28 | 🌐 C | 📅 2026-08-17 - Small and highly portable detection tests mapped to the MITRE ATT\&CK Framework.
* [Caldera](https://github.com/mitre/caldera) ⭐ 7,209 | 🐛 76 | 🌐 Python | 📅 2026-08-12 - Automated adversary emulation system that performs post-compromise adversarial behavior within Windows Enterprise networks. It generates plans during operation using a planning system and a pre-configured adversary model based on the Adversarial Tactics, Techniques & Common Knowledge (ATT\&CK™) project.
...
* [Flare](https://github.com/fireeye/flare-vm) ⭐ 8,948 | 🐛 28 | 🌐 PowerShell | 📅 2026-06-23 - A fully customizable, Windows-based security distribution for malware analysis, incident response, penetration testing.
* [Fleetdm](https://github.com/fleetdm/fleet) ⭐ 6,756 | 🐛 3,490 | 🌐 Go | 📅 2026-08-21 - State of the art host monitoring platform tailored for security experts. Leveraging Facebook's battle-tested osquery project, Fleetdm delivers continuous updates, features and fast answers to big questions.
...
* [IRIS](https://github.com/dfir-iris/iris-web) ⭐ 1,543 | 🐛 420 | 🌐 Python | 📅 2026-07-13 - IRIS is a web collaborative platform for incident response analysts allowing to share investigations at a technical level.
...
* [Zentral](https://github.com/zentralopensource/zentral) ⭐ 876 | 🐛 32 | 🌐 Python | 📅 2026-08-21 - Combines osquery's powerful endpoint inventory features with a flexible notification and action framework. This enables one to identify and react to changes on OS X and Linux clients.
...
* [Cynative](https://github.com/cynative/cynative) ⭐ 191 | 🐛 22 | 🌐 Go | 📅 2026-08-21 - Deep research agent for your infra - sandboxed, read-only, covers AWS, GCP, Azure, K8s, GitHub and GitLab.
...
* [bulk\_extractor](https://github.com/simsong/bulk_extractor) ⭐ 1,412 | 🐛 67 | 🌐 C++ | 📅 2026-08-18 - Computer forensics tool that scans a disk image, a file, or a directory of files and extracts useful information without parsing the file system or file system structures. Because of ignoring the file system structure, the program distinguishes itself in terms of speed and thoroughness.
* [Forensic Artifacts](https://github.com/ForensicArtifacts/artifacts) ⭐ 1,266 | 🐛 44 | 🌐 Python | 📅 2026-07-31 - Digital Forensics Artifact Repository
* [CyLR](https://github.com/orlikoski/CyLR) ⭐ 731 | 🐛 21 | 🌐 C# | 📅 2022-06-01 - The CyLR tool collects forensic artifacts from hosts with NTFS file systems quickly, securely and minimizes impact to the host.
...
* [Shuffle](https://github.com/frikky/Shuffle) ⭐ 2,417 | 🐛 490 | 🌐 JavaScript | 📅 2026-08-19 - A general purpose security automation platform focused on accessibility.
* [Fast Incident Response (FIR)](https://github.com/certsocietegenerale/FIR/) ⭐ 2,028 | 🐛 15 | 🌐 JavaScript | 📅 2026-08-07 - Cybersecurity incident management platform designed with agility and speed in mind. It allows for easy creation, tracking, and reporting of cybersecurity incidents and is useful for CSIRTs, CERTs and SOCs alike.
...
* [DFTimewolf](https://github.com/log2timeline/dftimewolf) ⭐ 352 | 🐛 4 | 🌐 Python | 📅 2026-08-21 - A framework for orchestrating forensic collection, processing and data export.
...
* [Sigma](https://github.com/SigmaHQ/sigma) ⭐ 10,924 | 🐛 194 | 🌐 Python | 📅 2026-08-18 - Generic signature format for SIEM systems already containing an extensive ruleset.
* [Chainsaw](https://github.com/countercept/chainsaw) ⭐ 3,638 | 🐛 4 | 🌐 Rust | 📅 2026-08-19 - Chainsaw provides a powerful ‘first-response’ capability to quickly identify threats within Windows event logs.
* [Hayabusa](https://github.com/Yamato-Security/hayabusa) ⭐ 3,317 | 🐛 22 | 🌐 Rust | 📅 2026-08-21 - Hayabusa is a Windows event log fast forensics timeline generator and threat hunting tool created by the Yamato Security group in Japan.
...
* [Volatility 3](https://github.com/volatilityfoundation/volatility3) ⭐ 4,341 | 🐛 135 | 🌐 Python | 📅 2026-08-19 - The volatile memory extraction framework (successor of Volatility)
* \[MemProcFS] (<https://github.com/ufrisk/MemProcFS> ⭐ 4,297 | 🐛 9 | 🌐 C | 📅 2026-08-17) - MemProcFS is an easy and convenient way of viewing physical memory as files in a virtual file system.
...
* [macOS Artifact Parsing Tool (mac\_apt)](https://github.com/ydkhatri/mac_apt) ⭐ 1,075 | 🐛 8 | 🌐 Python | 📅 2026-08-21 - Plugin based forensics framework for quick mac triage that works on live machines, disk images or individual artifact files.
...
* [Didier Stevens Suite](https://github.com/DidierStevens/DidierStevensSuite) ⭐ 2,522 | 🐛 13 | 🌐 Python | 📅 2026-07-30 - Tool collection
...
* [Hindsight](https://github.com/obsidianforensics/hindsight) ⭐ 1,489 | 🐛 7 | 🌐 Python | 📅 2026-08-09 - Internet history forensics for Google Chrome/Chromium.
...
* [Ghidra](https://github.com/NationalSecurityAgency/ghidra) ⭐ 72,628 | 🐛 1,916 | 🌐 Java | 📅 2026-08-20 - Software Reverse Engineering Framework.
* [Radare2](https://github.com/radareorg/radare2) ⭐ 24,613 | 🐛 821 | 🌐 C | 📅 2026-08-21 - Reverse engineering framework and command-line toolset.
* [Cutter](https://github.com/rizinorg/cutter) ⭐ 19,487 | 🐛 493 | 🌐 C++ | 📅 2026-08-13 - Free and Open Source Reverse Engineering Platform powered by rizin.
* [CAPA](https://github.com/mandiant/capa) ⭐ 6,151 | 🐛 291 | 🌐 Python | 📅 2026-08-18 - detects capabilities in executable files. You run it against a PE, ELF, .NET module, or shellcode file and it tells you what it thinks the program can do.
* [Cuckoo](https://github.com/cuckoosandbox/cuckoo) ⚠️ Archived - Open Source Highly configurable sandboxing tool.
* [Rizin](https://github.com/rizinorg/rizin) ⭐ 3,796 | 🐛 548 | 🌐 C | 📅 2026-08-21 - UNIX-like reverse engineering framework and command-line toolset
* [CAPEv2](https://github.com/kevoreilly/CAPEv2) ⭐ 3,438 | 🐛 51 | 🌐 Python | 📅 2026-08-21 - Malware Configuration And Payload Extraction.
...
* [LOKI](https://github.com/Neo23x0/Loki) ⭐ 3,782 | 🐛 18 | 🌐 Python | 📅 2026-01-12 - Free IR scanner for scanning endpoint with yara rules and other indicators(IOCs).
...
* [Plaso](https://github.com/log2timeline/plaso) ⭐ 2,137 | 🐛 283 | 🌐 Python | 📅 2026-08-03 -  a Python-based backend engine for the tool log2timeline.
...
* [LOKI](https://github.com/Neo23x0/Loki) ⭐ 3,782 | 🐛 18 | 🌐 Python | 📅 2026-01-12 - Free IR scanner for scanning endpoint with yara rules and other indicators(IOCs).
* [Fibratus](https://github.com/rabbitstack/fibratus) ⭐ 2,534 | 🐛 42 | 🌐 Go | 📅 2026-08-19 - Tool for exploration and tracing of the Windows kernel.
