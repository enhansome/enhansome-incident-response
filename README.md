...
* [Atomic Red Team (ART)](https://github.com/redcanaryco/atomic-red-team) ⭐ 12,578 | 🐛 35 | 🌐 C | 📅 2026-09-14 - Small and highly portable detection tests mapped to the MITRE ATT\&CK Framework.
* [Caldera](https://github.com/mitre/caldera) ⭐ 7,287 | 🐛 74 | 🌐 Python | 📅 2026-08-27 - Automated adversary emulation system that performs post-compromise adversarial behavior within Windows Enterprise networks. It generates plans during operation using a planning system and a pre-configured adversary model based on the Adversarial Tactics, Techniques & Common Knowledge (ATT\&CK™) project.
* [APTSimulator](https://github.com/NextronSystems/APTSimulator) ⭐ 2,773 | 🐛 4 | 🌐 Batchfile | 📅 2025-09-23 - Windows Batch script that uses a set of tools and output files to make a system look as if it was compromised.
* [Network Flight Simulator](https://github.com/alphasoc/flightsim) ⭐ 1,364 | 🐛 24 | 🌐 Go | 📅 2024-04-04 - Lightweight utility used to generate malicious network traffic and help security teams to evaluate security controls and network visibility.
...
* [Flare](https://github.com/fireeye/flare-vm) ⭐ 9,062 | 🐛 26 | 🌐 PowerShell | 📅 2026-06-23 - A fully customizable, Windows-based security distribution for malware analysis, incident response, penetration testing.
* [Fleetdm](https://github.com/fleetdm/fleet) ⭐ 6,910 | 🐛 3,625 | 🌐 Go | 📅 2026-09-24 - State of the art host monitoring platform tailored for security experts. Leveraging Facebook's battle-tested osquery project, Fleetdm delivers continuous updates, features and fast answers to big questions.
...
* [Velociraptor](https://github.com/Velocidex/velociraptor) ⭐ 4,270 | 🐛 77 | 🌐 Go | 📅 2026-09-24 - Endpoint visibility and collection tool
...
* [IRIS](https://github.com/dfir-iris/iris-web) ⭐ 1,565 | 🐛 434 | 🌐 Shell | 📅 2026-09-24 - IRIS is a web collaborative platform for incident response analysts allowing to share investigations at a technical level.
* [Dissect](https://github.com/fox-it/dissect) ⭐ 1,160 | 🐛 13 | 📅 2026-09-24 - Dissect is a digital forensics & incident response framework and toolset that allows you to quickly access and analyse forensic artefacts from various disk and file formats, developed by Fox-IT (part of NCC Group).
* [Kuiper](https://github.com/DFIRKuiper/Kuiper) ⭐ 907 | 🐛 12 | 🌐 JavaScript | 📅 2024-10-12 - Digital Forensics Investigation Platform
* [Zentral](https://github.com/zentralopensource/zentral) ⭐ 884 | 🐛 39 | 🌐 Python | 📅 2026-09-24 - Combines osquery's powerful endpoint inventory features with a flexible notification and action framework. This enables one to identify and react to changes on OS X and Linux clients.
...
* [Cynative](https://github.com/cynative/cynative) ⭐ 207 | 🐛 20 | 🌐 Go | 📅 2026-09-24 - Deep research agent for your infra - sandboxed, read-only, covers AWS, GCP, Azure, K8s, GitHub and GitLab.
* [VanGuard](https://github.com/ridgelinecyberdefence/vanguard) ⭐ 156 | 🐛 0 | 🌐 Go | 📅 2026-07-28 - Cross-platform incident response toolkit with 28 pre-built use cases in a single zero-install binary. Collects memory, disk, network, and cloud artifacts with automated timeline generation.
...
* [UAC](https://github.com/tclahr/uac) ⭐ 1,461 | 🐛 8 | 🌐 Shell | 📅 2026-09-09 - UAC (Unix-like Artifacts Collector) is a Live Response collection script for Incident Response that makes use of native binaries and tools to automate the collection of AIX, Android, ESXi, FreeBSD, Linux, macOS, NetBSD, NetScaler, OpenBSD and Solaris systems artifacts.
* [bulk\_extractor](https://github.com/simsong/bulk_extractor) ⭐ 1,424 | 🐛 67 | 🌐 C++ | 📅 2026-09-01 - Computer forensics tool that scans a disk image, a file, or a directory of files and extracts useful information without parsing the file system or file system structures. Because of ignoring the file system structure, the program distinguishes itself in terms of speed and thoroughness.
* [Forensic Artifacts](https://github.com/ForensicArtifacts/artifacts) ⭐ 1,276 | 🐛 44 | 🌐 Python | 📅 2026-07-31 - Digital Forensics Artifact Repository
...
* [Shuffle](https://github.com/frikky/Shuffle) ⭐ 2,442 | 🐛 491 | 🌐 JavaScript | 📅 2026-09-24 - A general purpose security automation platform focused on accessibility.
...
* [DFTimewolf](https://github.com/log2timeline/dftimewolf) ⭐ 356 | 🐛 5 | 🌐 Python | 📅 2026-09-21 - A framework for orchestrating forensic collection, processing and data export.
...
* [Windows Events Attack Samples](https://github.com/sbousseaden/EVTX-ATTACK-SAMPLES) ⭐ 2,628 | 🐛 5 | 🌐 HTML | 📅 2023-01-24 - Windows Events Attack Samples
...
* [NullSec Linux](https://github.com/bad-antics/nullsec-linux) ⭐ 85 | 🐛 2 | 🌐 Shell | 📅 2026-04-17 - Security-focused Linux distribution with 140+ pre-installed forensic and offensive security tools, custom hardened kernel, and integrated incident response workflows.
...
* [MAGNET DumpIt](https://github.com/MagnetForensics/dumpit-linux) ⭐ 252 | 🐛 3 | 🌐 Rust | 📅 2023-11-21 - Fast memory acquisition open source tool for Linux written in Rust. Generate full memory crash dumps of Linux machines.
...
* [Sigma](https://github.com/SigmaHQ/sigma) ⭐ 11,088 | 🐛 222 | 🌐 Python | 📅 2026-09-24 - Generic signature format for SIEM systems already containing an extensive ruleset.
* [Chainsaw](https://github.com/countercept/chainsaw) ⭐ 3,670 | 🐛 4 | 🌐 Rust | 📅 2026-09-23 - Chainsaw provides a powerful ‘first-response’ capability to quickly identify threats within Windows event logs.
* [Hayabusa](https://github.com/Yamato-Security/hayabusa) ⭐ 3,360 | 🐛 19 | 🌐 Rust | 📅 2026-09-12 - Hayabusa is a Windows event log fast forensics timeline generator and threat hunting tool created by the Yamato Security group in Japan.
* [LogonTracer](https://github.com/JPCERTCC/LogonTracer) ⭐ 3,257 | 🐛 22 | 🌐 Python | 📅 2026-08-02 - Tool to investigate malicious Windows logon by visualizing and analyzing Windows event log.
...
* [Zircolite](https://github.com/wagga40/Zircolite) ⭐ 853 | 🐛 6 | 🌐 Python | 📅 2026-09-20 - A standalone and fast SIGMA-based detection tool for EVTX or JSON.
...
* [WELA](https://github.com/Yamato-Security/WELA) ⭐ 121 | 🐛 31 | 🌐 PowerShell | 📅 2026-09-23 - Windows Event Log Analyzer aims to be the Swiss Army knife for Windows event logs.
...
* [Volatility 3](https://github.com/volatilityfoundation/volatility3) ⭐ 4,431 | 🐛 139 | 🌐 Python | 📅 2026-09-17 - The volatile memory extraction framework (successor of Volatility)
* \[MemProcFS] (<https://github.com/ufrisk/MemProcFS> ⭐ 4,349 | 🐛 7 | 🌐 C | 📅 2026-09-14) - MemProcFS is an easy and convenient way of viewing physical memory as files in a virtual file system.
...
* [Orochi](https://github.com/LDO-CERT/orochi) ⭐ 276 | 🐛 69 | 🌐 JavaScript | 📅 2026-09-22 - Orochi is an open source framework for collaborative forensic memory dump analysis.
* [VolatilityBot](https://github.com/mkorman90/VolatilityBot) ⭐ 269 | 🐛 1 | 🌐 Python | 📅 2021-06-15 - Automation tool for researchers cuts all the guesswork and manual tasks out of the binary extraction phase, or to help the investigator in the first steps of performing a memory analysis investigation.
...
* [Didier Stevens Suite](https://github.com/DidierStevens/DidierStevensSuite) ⭐ 2,540 | 🐛 13 | 🌐 Python | 📅 2026-09-23 - Tool collection
* [List of various Security APIs](https://github.com/deralexxx/security-apis) ⭐ 992 | 🐛 5 | 📅 2026-09-08 - Collective list of public JSON APIs for use in security.
...
* [sysmon-config](https://github.com/SwiftOnSecurity/sysmon-config) ⭐ 5,658 | 🐛 82 | 📅 2024-07-03 - Sysmon configuration file template with default high-quality event tracing
* [HELK](https://github.com/Cyb3rWard0g/HELK) ⭐ 3,928 | 🐛 60 | 🌐 Jupyter Notebook | 📅 2024-06-01 - Threat Hunting platform.
* [sysmon-modular](https://github.com/olafhartong/sysmon-modular) ⭐ 3,141 | 🐛 50 | 🌐 Go | 📅 2026-09-18 - A repository of sysmon configuration modules
...
* [Kansa](https://github.com/davehull/Kansa/) ⭐ 1,659 | 🐛 46 | 🌐 PowerShell | 📅 2022-11-22 - Modular incident response framework in PowerShell.
* [Hindsight](https://github.com/obsidianforensics/hindsight) ⭐ 1,514 | 🐛 37 | 🌐 Python | 📅 2026-09-23 - Internet history forensics for Google Chrome/Chromium.
...
* [ThreatHunter-Playbook](https://github.com/OTRF/ThreatHunter-Playbook) ⭐ 4,672 | 🐛 6 | 🌐 Python | 📅 2026-01-12 - Playbook to aid the development of techniques and hypothesis for hunting campaigns.
* [IRM](https://github.com/certsocietegenerale/IRM) ⭐ 1,143 | 🐛 0 | 📅 2025-04-11 - Incident Response Methodologies by CERT Societe Generale.
* [AWS Incident Response Runbook Samples](https://github.com/aws-samples/aws-incident-response-runbooks/tree/0d9a1c0f7ad68fb2c1b2d86be8914f2069492e21) ⭐ 1,111 | 🐛 1 | 📅 2026-08-28 - AWS IR Runbook Samples meant to be customized per each entity using them. The three samples are: "DoS or DDoS attack", "credential leakage", and "unintended access to an Amazon S3 bucket".
...
* [Ghidra](https://github.com/NationalSecurityAgency/ghidra) ⭐ 79,584 | 🐛 1,956 | 🌐 Java | 📅 2026-09-24 - Software Reverse Engineering Framework.
* [Radare2](https://github.com/radareorg/radare2) ⭐ 24,866 | 🐛 822 | 🌐 C | 📅 2026-09-24 - Reverse engineering framework and command-line toolset.
* [Cutter](https://github.com/rizinorg/cutter) ⭐ 19,801 | 🐛 495 | 🌐 C++ | 📅 2026-09-11 - Free and Open Source Reverse Engineering Platform powered by rizin.
* [CAPA](https://github.com/mandiant/capa) ⭐ 6,197 | 🐛 307 | 🌐 Python | 📅 2026-09-14 - detects capabilities in executable files. You run it against a PE, ELF, .NET module, or shellcode file and it tells you what it thinks the program can do.
* [Cuckoo](https://github.com/cuckoosandbox/cuckoo) ⚠️ Archived - Open Source Highly configurable sandboxing tool.
* [Rizin](https://github.com/rizinorg/rizin) ⭐ 3,915 | 🐛 588 | 🌐 C | 📅 2026-09-24 - UNIX-like reverse engineering framework and command-line toolset
* [CAPEv2](https://github.com/kevoreilly/CAPEv2) ⭐ 3,527 | 🐛 75 | 🌐 Python | 📅 2026-09-24 - Malware Configuration And Payload Extraction.
...
* [Timesketch](https://github.com/google/timesketch) ⭐ 3,422 | 🐛 218 | 🌐 Python | 📅 2026-09-24 - Open source tool for collaborative forensic timeline analysis.
...
* [Aurora Incident Response](https://github.com/cyb3rfox/Aurora-Incident-Response) ⭐ 1,083 | 🐛 41 | 🌐 JavaScript | 📅 2023-10-05 - Platform developed to build easily a detailed timeline of an incident.
...
* [LOKI](https://github.com/Neo23x0/Loki) ⭐ 3,790 | 🐛 18 | 🌐 Python | 📅 2026-01-12 - Free IR scanner for scanning endpoint with yara rules and other indicators(IOCs).
* [Fibratus](https://github.com/rabbitstack/fibratus) ⭐ 2,551 | 🐛 44 | 🌐 Go | 📅 2026-09-24 - Tool for exploration and tracing of the Windows kernel.
