...
* [Atomic Red Team (ART)](https://github.com/redcanaryco/atomic-red-team) ⭐ 12,457 | 🐛 31 | 🌐 C | 📅 2026-08-24 - Small and highly portable detection tests mapped to the MITRE ATT\&CK Framework.
* [Caldera](https://github.com/mitre/caldera) ⭐ 7,213 | 🐛 73 | 🌐 Python | 📅 2026-08-12 - Automated adversary emulation system that performs post-compromise adversarial behavior within Windows Enterprise networks. It generates plans during operation using a planning system and a pre-configured adversary model based on the Adversarial Tactics, Techniques & Common Knowledge (ATT\&CK™) project.
* [APTSimulator](https://github.com/NextronSystems/APTSimulator) ⭐ 2,764 | 🐛 4 | 🌐 Batchfile | 📅 2025-09-23 - Windows Batch script that uses a set of tools and output files to make a system look as if it was compromised.
...
* [RedHunt-OS](https://github.com/redhuntlabs/RedHunt-OS) ⭐ 1,318 | 🐛 7 | 📅 2025-01-22 - Virtual machine for adversary emulation and threat hunting.
...
* [Flare](https://github.com/fireeye/flare-vm) ⭐ 8,965 | 🐛 28 | 🌐 PowerShell | 📅 2026-06-23 - A fully customizable, Windows-based security distribution for malware analysis, incident response, penetration testing.
* [Fleetdm](https://github.com/fleetdm/fleet) ⭐ 6,780 | 🐛 3,490 | 🌐 Go | 📅 2026-08-26 - State of the art host monitoring platform tailored for security experts. Leveraging Facebook's battle-tested osquery project, Fleetdm delivers continuous updates, features and fast answers to big questions.
...
* [IRIS](https://github.com/dfir-iris/iris-web) ⭐ 1,547 | 🐛 422 | 🌐 Python | 📅 2026-08-24 - IRIS is a web collaborative platform for incident response analysts allowing to share investigations at a technical level.
...
* [Kuiper](https://github.com/DFIRKuiper/Kuiper) ⭐ 902 | 🐛 12 | 🌐 JavaScript | 📅 2024-10-12 - Digital Forensics Investigation Platform
* [Zentral](https://github.com/zentralopensource/zentral) ⭐ 879 | 🐛 34 | 🌐 Python | 📅 2026-08-26 - Combines osquery's powerful endpoint inventory features with a flexible notification and action framework. This enables one to identify and react to changes on OS X and Linux clients.
...
* [Cynative](https://github.com/cynative/cynative) ⭐ 193 | 🐛 16 | 🌐 Go | 📅 2026-08-26 - Deep research agent for your infra - sandboxed, read-only, covers AWS, GCP, Azure, K8s, GitHub and GitLab.
...
* [UAC](https://github.com/tclahr/uac) ⭐ 1,437 | 🐛 9 | 🌐 Shell | 📅 2026-08-25 - UAC (Unix-like Artifacts Collector) is a Live Response collection script for Incident Response that makes use of native binaries and tools to automate the collection of AIX, Android, ESXi, FreeBSD, Linux, macOS, NetBSD, NetScaler, OpenBSD and Solaris systems artifacts.
...
* [Shuffle](https://github.com/frikky/Shuffle) ⭐ 2,421 | 🐛 492 | 🌐 JavaScript | 📅 2026-08-24 - A general purpose security automation platform focused on accessibility.
...
* [Windows Events Attack Samples](https://github.com/sbousseaden/EVTX-ATTACK-SAMPLES) ⭐ 2,614 | 🐛 5 | 🌐 HTML | 📅 2023-01-24 - Windows Events Attack Samples
...
* [Sigma](https://github.com/SigmaHQ/sigma) ⭐ 10,942 | 🐛 203 | 🌐 Python | 📅 2026-08-18 - Generic signature format for SIEM systems already containing an extensive ruleset.
* [Chainsaw](https://github.com/countercept/chainsaw) ⭐ 3,648 | 🐛 4 | 🌐 Rust | 📅 2026-08-25 - Chainsaw provides a powerful ‘first-response’ capability to quickly identify threats within Windows event logs.
* [Hayabusa](https://github.com/Yamato-Security/hayabusa) ⭐ 3,324 | 🐛 20 | 🌐 Rust | 📅 2026-08-22 - Hayabusa is a Windows event log fast forensics timeline generator and threat hunting tool created by the Yamato Security group in Japan.
* [LogonTracer](https://github.com/JPCERTCC/LogonTracer) ⭐ 3,221 | 🐛 21 | 🌐 Python | 📅 2026-08-02 - Tool to investigate malicious Windows logon by visualizing and analyzing Windows event log.
...
* [Zircolite](https://github.com/wagga40/Zircolite) ⭐ 848 | 🐛 0 | 🌐 Python | 📅 2026-08-24 - A standalone and fast SIGMA-based detection tool for EVTX or JSON.
...
* [WELA](https://github.com/Yamato-Security/WELA) ⭐ 119 | 🐛 5 | 🌐 PowerShell | 📅 2026-08-01 - Windows Event Log Analyzer aims to be the Swiss Army knife for Windows event logs.
...
* [Volatility 3](https://github.com/volatilityfoundation/volatility3) ⭐ 4,357 | 🐛 135 | 🌐 Python | 📅 2026-08-19 - The volatile memory extraction framework (successor of Volatility)
* \[MemProcFS] (<https://github.com/ufrisk/MemProcFS> ⭐ 4,300 | 🐛 9 | 🌐 C | 📅 2026-08-25) - MemProcFS is an easy and convenient way of viewing physical memory as files in a virtual file system.
...
* [Awesome Forensics](https://github.com/cugu/awesome-forensics) ⭐ 5,165 | 🐛 8 | 📅 2026-08-23 - A curated list of awesome forensic analysis tools and resources.
...
* [Hindsight](https://github.com/obsidianforensics/hindsight) ⭐ 1,497 | 🐛 7 | 🌐 Python | 📅 2026-08-23 - Internet history forensics for Google Chrome/Chromium.
...
* [ThreatHunter-Playbook](https://github.com/OTRF/ThreatHunter-Playbook) ⭐ 4,643 | 🐛 6 | 🌐 Python | 📅 2026-01-12 - Playbook to aid the development of techniques and hypothesis for hunting campaigns.
* [IRM](https://github.com/certsocietegenerale/IRM) ⭐ 1,140 | 🐛 0 | 📅 2025-04-11 - Incident Response Methodologies by CERT Societe Generale.
* [AWS Incident Response Runbook Samples](https://github.com/aws-samples/aws-incident-response-runbooks/tree/0d9a1c0f7ad68fb2c1b2d86be8914f2069492e21) ⭐ 1,099 | 🐛 2 | 📅 2026-08-07 - AWS IR Runbook Samples meant to be customized per each entity using them. The three samples are: "DoS or DDoS attack", "credential leakage", and "unintended access to an Amazon S3 bucket".
...
* [Ghidra](https://github.com/NationalSecurityAgency/ghidra) ⭐ 72,867 | 🐛 1,920 | 🌐 Java | 📅 2026-08-25 - Software Reverse Engineering Framework.
* [Radare2](https://github.com/radareorg/radare2) ⭐ 24,651 | 🐛 820 | 🌐 C | 📅 2026-08-26 - Reverse engineering framework and command-line toolset.
* [Cutter](https://github.com/rizinorg/cutter) ⭐ 19,572 | 🐛 493 | 🌐 C++ | 📅 2026-08-22 - Free and Open Source Reverse Engineering Platform powered by rizin.
* [CAPA](https://github.com/mandiant/capa) ⭐ 6,156 | 🐛 295 | 🌐 Python | 📅 2026-08-26 - detects capabilities in executable files. You run it against a PE, ELF, .NET module, or shellcode file and it tells you what it thinks the program can do.
* [Cuckoo](https://github.com/cuckoosandbox/cuckoo) ⚠️ Archived - Open Source Highly configurable sandboxing tool.
* [Rizin](https://github.com/rizinorg/rizin) ⭐ 3,806 | 🐛 550 | 🌐 C | 📅 2026-08-26 - UNIX-like reverse engineering framework and command-line toolset
* [CAPEv2](https://github.com/kevoreilly/CAPEv2) ⭐ 3,451 | 🐛 57 | 🌐 Python | 📅 2026-08-23 - Malware Configuration And Payload Extraction.
...
* [Timesketch](https://github.com/google/timesketch) ⭐ 3,396 | 🐛 220 | 🌐 Python | 📅 2026-08-24 - Open source tool for collaborative forensic timeline analysis.
* [Plaso](https://github.com/log2timeline/plaso) ⭐ 2,140 | 🐛 285 | 🌐 Python | 📅 2026-08-03 -  a Python-based backend engine for the tool log2timeline.
