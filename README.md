...
* [Atomic Red Team (ART)](https://github.com/redcanaryco/atomic-red-team) ⭐ 12,489 | 🐛 31 | 🌐 C | 📅 2026-09-05 - Small and highly portable detection tests mapped to the MITRE ATT\&CK Framework.
* [Caldera](https://github.com/mitre/caldera) ⭐ 7,240 | 🐛 71 | 🌐 Python | 📅 2026-08-27 - Automated adversary emulation system that performs post-compromise adversarial behavior within Windows Enterprise networks. It generates plans during operation using a planning system and a pre-configured adversary model based on the Adversarial Tactics, Techniques & Common Knowledge (ATT\&CK™) project.
* [APTSimulator](https://github.com/NextronSystems/APTSimulator) ⭐ 2,766 | 🐛 4 | 🌐 Batchfile | 📅 2025-09-23 - Windows Batch script that uses a set of tools and output files to make a system look as if it was compromised.
...
* [Flare](https://github.com/fireeye/flare-vm) ⭐ 8,999 | 🐛 28 | 🌐 PowerShell | 📅 2026-06-23 - A fully customizable, Windows-based security distribution for malware analysis, incident response, penetration testing.
* [Fleetdm](https://github.com/fleetdm/fleet) ⭐ 6,813 | 🐛 3,470 | 🌐 Go | 📅 2026-09-06 - State of the art host monitoring platform tailored for security experts. Leveraging Facebook's battle-tested osquery project, Fleetdm delivers continuous updates, features and fast answers to big questions.
...
* [Velociraptor](https://github.com/Velocidex/velociraptor) ⭐ 4,236 | 🐛 74 | 🌐 Go | 📅 2026-09-05 - Endpoint visibility and collection tool
...
* [Matano](https://github.com/matanolabs/matano) ⭐ 1,695 | 🐛 55 | 🌐 Rust | 📅 2025-01-08: Open source serverless security lake platform on AWS that lets you ingest, store, and analyze petabytes of security data into an Apache Iceberg data lake and run realtime Python detections as code.
...
* [Zentral](https://github.com/zentralopensource/zentral) ⭐ 880 | 🐛 39 | 🌐 Python | 📅 2026-09-04 - Combines osquery's powerful endpoint inventory features with a flexible notification and action framework. This enables one to identify and react to changes on OS X and Linux clients.
...
* [Cynative](https://github.com/cynative/cynative) ⭐ 197 | 🐛 21 | 🌐 Go | 📅 2026-09-06 - Deep research agent for your infra - sandboxed, read-only, covers AWS, GCP, Azure, K8s, GitHub and GitLab.
...
* [UAC](https://github.com/tclahr/uac) ⭐ 1,445 | 🐛 10 | 🌐 Shell | 📅 2026-09-03 - UAC (Unix-like Artifacts Collector) is a Live Response collection script for Incident Response that makes use of native binaries and tools to automate the collection of AIX, Android, ESXi, FreeBSD, Linux, macOS, NetBSD, NetScaler, OpenBSD and Solaris systems artifacts.
...
* [Shuffle](https://github.com/frikky/Shuffle) ⭐ 2,426 | 🐛 492 | 🌐 JavaScript | 📅 2026-09-05 - A general purpose security automation platform focused on accessibility.
...
* [Sigma](https://github.com/SigmaHQ/sigma) ⭐ 10,989 | 🐛 197 | 🌐 Python | 📅 2026-09-03 - Generic signature format for SIEM systems already containing an extensive ruleset.
...
* \[MemProcFS] (<https://github.com/ufrisk/MemProcFS> ⭐ 4,321 | 🐛 6 | 🌐 C | 📅 2026-09-06) - MemProcFS is an easy and convenient way of viewing physical memory as files in a virtual file system.
...
* [sysmon-modular](https://github.com/olafhartong/sysmon-modular) ⭐ 3,128 | 🐛 49 | 🌐 PowerShell | 📅 2026-08-31 - A repository of sysmon configuration modules
...
* [Hindsight](https://github.com/obsidianforensics/hindsight) ⭐ 1,501 | 🐛 9 | 🌐 Python | 📅 2026-09-06 - Internet history forensics for Google Chrome/Chromium.
...
* [Ghidra](https://github.com/NationalSecurityAgency/ghidra) ⭐ 74,483 | 🐛 1,947 | 🌐 Java | 📅 2026-09-02 - Software Reverse Engineering Framework.
* [Radare2](https://github.com/radareorg/radare2) ⭐ 24,747 | 🐛 819 | 🌐 C | 📅 2026-09-06 - Reverse engineering framework and command-line toolset.
* [Cutter](https://github.com/rizinorg/cutter) ⭐ 19,686 | 🐛 493 | 🌐 C++ | 📅 2026-08-22 - Free and Open Source Reverse Engineering Platform powered by rizin.
* [CAPA](https://github.com/mandiant/capa) ⭐ 6,173 | 🐛 298 | 🌐 Python | 📅 2026-09-06 - detects capabilities in executable files. You run it against a PE, ELF, .NET module, or shellcode file and it tells you what it thinks the program can do.
* [Cuckoo](https://github.com/cuckoosandbox/cuckoo) ⚠️ Archived - Open Source Highly configurable sandboxing tool.
* [Rizin](https://github.com/rizinorg/rizin) ⭐ 3,867 | 🐛 566 | 🌐 C | 📅 2026-09-06 - UNIX-like reverse engineering framework and command-line toolset
* [CAPEv2](https://github.com/kevoreilly/CAPEv2) ⭐ 3,473 | 🐛 64 | 🌐 Python | 📅 2026-09-03 - Malware Configuration And Payload Extraction.
...
* [Timesketch](https://github.com/google/timesketch) ⭐ 3,409 | 🐛 217 | 🌐 Python | 📅 2026-09-03 - Open source tool for collaborative forensic timeline analysis.
...
* [LOKI](https://github.com/Neo23x0/Loki) ⭐ 3,788 | 🐛 18 | 🌐 Python | 📅 2026-01-12 - Free IR scanner for scanning endpoint with yara rules and other indicators(IOCs).
* [Fibratus](https://github.com/rabbitstack/fibratus) ⭐ 2,539 | 🐛 43 | 🌐 Go | 📅 2026-09-05 - Tool for exploration and tracing of the Windows kernel.
